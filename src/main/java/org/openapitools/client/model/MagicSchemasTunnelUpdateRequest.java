...
public class MagicSchemasTunnelUpdateRequest {
  ...
  public MagicSchemasTunnelUpdateRequest() {
  }

  public MagicSchemasTunnelUpdateRequest cloudflareEndpoint(String cloudflareEndpoint) {
  ...
  **/
  ...
  public MagicSchemasTunnelUpdateRequest customerEndpoint(String customerEndpoint) {
  ...
  **/
  ...
  public MagicSchemasTunnelUpdateRequest description(String description) {
  ...
  **/
  ...
  public MagicSchemasTunnelUpdateRequest healthCheck(MagicHealthCheck healthCheck) {
  ...
  **/
  ...
  public MagicSchemasTunnelUpdateRequest interfaceAddress(String interfaceAddress) {
  ...
  **/
  ...
  public MagicSchemasTunnelUpdateRequest name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public MagicSchemasTunnelUpdateRequest psk(String psk) {
    this.psk = psk;
    return this;
  }
  ...
  **/
  ...
  public MagicSchemasTunnelUpdateRequest replayProtection(Boolean replayProtection) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    MagicSchemasTunnelUpdateRequest magicSchemasTunnelUpdateRequest = (MagicSchemasTunnelUpdateRequest) o;
    return Objects.equals(this.cloudflareEndpoint, magicSchemasTunnelUpdateRequest.cloudflareEndpoint) &&
        Objects.equals(this.customerEndpoint, magicSchemasTunnelUpdateRequest.customerEndpoint) &&
        Objects.equals(this.description, magicSchemasTunnelUpdateRequest.description) &&
        Objects.equals(this.healthCheck, magicSchemasTunnelUpdateRequest.healthCheck) &&
        Objects.equals(this.interfaceAddress, magicSchemasTunnelUpdateRequest.interfaceAddress) &&
        Objects.equals(this.name, magicSchemasTunnelUpdateRequest.name) &&
        Objects.equals(this.psk, magicSchemasTunnelUpdateRequest.psk) &&
        Objects.equals(this.replayProtection, magicSchemasTunnelUpdateRequest.replayProtection);
  }
  ...
  public String toString() {
    ...
    sb.append("class MagicSchemasTunnelUpdateRequest {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to MagicSchemasTunnelUpdateRequest
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MagicSchemasTunnelUpdateRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MagicSchemasTunnelUpdateRequest is not found in the empty JSON string", MagicSchemasTunnelUpdateRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MagicSchemasTunnelUpdateRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MagicSchemasTunnelUpdateRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : MagicSchemasTunnelUpdateRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MagicSchemasTunnelUpdateRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MagicSchemasTunnelUpdateRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MagicSchemasTunnelUpdateRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MagicSchemasTunnelUpdateRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<MagicSchemasTunnelUpdateRequest>() {
           @Override
           public void write(JsonWriter out, MagicSchemasTunnelUpdateRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MagicSchemasTunnelUpdateRequest read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of MagicSchemasTunnelUpdateRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of MagicSchemasTunnelUpdateRequest
  * @throws IOException if the JSON string is invalid with respect to MagicSchemasTunnelUpdateRequest
  */
  public static MagicSchemasTunnelUpdateRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MagicSchemasTunnelUpdateRequest.class);
  }

 /**
  * Convert an instance of MagicSchemasTunnelUpdateRequest to an JSON string
  *
  * @return JSON string
  */
