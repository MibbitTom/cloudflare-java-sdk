...
public class AccessVncProps {
  ...
  public AccessVncProps() {
  }

  public AccessVncProps allowAuthenticateViaWarp(Boolean allowAuthenticateViaWarp) {
  ...
  **/
  ...
  public AccessVncProps allowedIdps(List<String> allowedIdps) {
    this.allowedIdps = allowedIdps;
    return this;
  }

  public AccessVncProps addAllowedIdpsItem(String allowedIdpsItem) {
  ...
  **/
  ...
  public AccessVncProps appLauncherVisible(Boolean appLauncherVisible) {
  ...
  **/
  ...
  public AccessVncProps autoRedirectToIdentity(Boolean autoRedirectToIdentity) {
  ...
  **/
  ...
  public AccessVncProps corsHeaders(AccessCorsHeaders corsHeaders) {
  ...
  **/
  ...
  public AccessVncProps customDenyMessage(String customDenyMessage) {
  ...
  **/
  ...
  public AccessVncProps customDenyUrl(String customDenyUrl) {
  ...
  **/
  ...
  public AccessVncProps customNonIdentityDenyUrl(String customNonIdentityDenyUrl) {
  ...
  **/
  ...
  public AccessVncProps customPages(List<String> customPages) {
    this.customPages = customPages;
    return this;
  }

  public AccessVncProps addCustomPagesItem(String customPagesItem) {
  ...
  **/
  ...
  public AccessVncProps domain(String domain) {
    this.domain = domain;
    return this;
  }
  ...
  **/
  ...
  public AccessVncProps enableBindingCookie(Boolean enableBindingCookie) {
  ...
  **/
  ...
  public AccessVncProps httpOnlyCookieAttribute(Boolean httpOnlyCookieAttribute) {
  ...
  **/
  ...
  public AccessVncProps logoUrl(String logoUrl) {
  ...
  **/
  ...
  public AccessVncProps name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public AccessVncProps optionsPreflightBypass(Boolean optionsPreflightBypass) {
  ...
  **/
  ...
  public AccessVncProps pathCookieAttribute(Boolean pathCookieAttribute) {
  ...
  **/
  ...
  public AccessVncProps sameSiteCookieAttribute(String sameSiteCookieAttribute) {
  ...
  **/
  ...
  public AccessVncProps selfHostedDomains(List<String> selfHostedDomains) {
    this.selfHostedDomains = selfHostedDomains;
    return this;
  }

  public AccessVncProps addSelfHostedDomainsItem(String selfHostedDomainsItem) {
  ...
  **/
  ...
  public AccessVncProps serviceAuth401Redirect(Boolean serviceAuth401Redirect) {
  ...
  **/
  ...
  public AccessVncProps sessionDuration(String sessionDuration) {
  ...
  **/
  ...
  public AccessVncProps skipInterstitial(Boolean skipInterstitial) {
  ...
  **/
  ...
  public AccessVncProps tags(List<String> tags) {
    this.tags = tags;
    return this;
  }

  public AccessVncProps addTagsItem(String tagsItem) {
    if (this.tags == null) {
  ...
  **/
  ...
  public AccessVncProps type(String type) {
    this.type = type;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    AccessVncProps accessVncProps = (AccessVncProps) o;
    return Objects.equals(this.allowAuthenticateViaWarp, accessVncProps.allowAuthenticateViaWarp) &&
        Objects.equals(this.allowedIdps, accessVncProps.allowedIdps) &&
        Objects.equals(this.appLauncherVisible, accessVncProps.appLauncherVisible) &&
        Objects.equals(this.autoRedirectToIdentity, accessVncProps.autoRedirectToIdentity) &&
        Objects.equals(this.corsHeaders, accessVncProps.corsHeaders) &&
        Objects.equals(this.customDenyMessage, accessVncProps.customDenyMessage) &&
        Objects.equals(this.customDenyUrl, accessVncProps.customDenyUrl) &&
        Objects.equals(this.customNonIdentityDenyUrl, accessVncProps.customNonIdentityDenyUrl) &&
        Objects.equals(this.customPages, accessVncProps.customPages) &&
        Objects.equals(this.domain, accessVncProps.domain) &&
        Objects.equals(this.enableBindingCookie, accessVncProps.enableBindingCookie) &&
        Objects.equals(this.httpOnlyCookieAttribute, accessVncProps.httpOnlyCookieAttribute) &&
        Objects.equals(this.logoUrl, accessVncProps.logoUrl) &&
        Objects.equals(this.name, accessVncProps.name) &&
        Objects.equals(this.optionsPreflightBypass, accessVncProps.optionsPreflightBypass) &&
        Objects.equals(this.pathCookieAttribute, accessVncProps.pathCookieAttribute) &&
        Objects.equals(this.sameSiteCookieAttribute, accessVncProps.sameSiteCookieAttribute) &&
        Objects.equals(this.selfHostedDomains, accessVncProps.selfHostedDomains) &&
        Objects.equals(this.serviceAuth401Redirect, accessVncProps.serviceAuth401Redirect) &&
        Objects.equals(this.sessionDuration, accessVncProps.sessionDuration) &&
        Objects.equals(this.skipInterstitial, accessVncProps.skipInterstitial) &&
        Objects.equals(this.tags, accessVncProps.tags) &&
        Objects.equals(this.type, accessVncProps.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class AccessVncProps {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to AccessVncProps
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AccessVncProps.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AccessVncProps is not found in the empty JSON string", AccessVncProps.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AccessVncProps.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AccessVncProps` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AccessVncProps.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AccessVncProps.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AccessVncProps' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AccessVncProps> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AccessVncProps.class));

       return (TypeAdapter<T>) new TypeAdapter<AccessVncProps>() {
           @Override
           public void write(JsonWriter out, AccessVncProps value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AccessVncProps read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of AccessVncProps given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AccessVncProps
  * @throws IOException if the JSON string is invalid with respect to AccessVncProps
  */
  public static AccessVncProps fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AccessVncProps.class);
  }

 /**
  * Convert an instance of AccessVncProps to an JSON string
  *
  * @return JSON string
  */
