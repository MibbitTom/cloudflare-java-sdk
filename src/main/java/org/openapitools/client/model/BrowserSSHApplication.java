...
public class BrowserSSHApplication {
  ...
  **/
  ...
  public BrowserSSHApplication allowAuthenticateViaWarp(Boolean allowAuthenticateViaWarp) {
  ...
  **/
  ...
  public BrowserSSHApplication allowedIdps(List<String> allowedIdps) {
    this.allowedIdps = allowedIdps;
    return this;
  }

  public BrowserSSHApplication addAllowedIdpsItem(String allowedIdpsItem) {
  ...
  **/
  ...
  public BrowserSSHApplication appLauncherVisible(Boolean appLauncherVisible) {
  ...
  **/
  ...
  public BrowserSSHApplication autoRedirectToIdentity(Boolean autoRedirectToIdentity) {
  ...
  **/
  ...
  public BrowserSSHApplication corsHeaders(AccessCorsHeaders corsHeaders) {
  ...
  **/
  ...
  public BrowserSSHApplication customDenyMessage(String customDenyMessage) {
  ...
  **/
  ...
  public BrowserSSHApplication customDenyUrl(String customDenyUrl) {
  ...
  **/
  ...
  public BrowserSSHApplication customNonIdentityDenyUrl(String customNonIdentityDenyUrl) {
  ...
  **/
  ...
  public BrowserSSHApplication customPages(List<String> customPages) {
    this.customPages = customPages;
    return this;
  }

  public BrowserSSHApplication addCustomPagesItem(String customPagesItem) {
  ...
  **/
  ...
  public BrowserSSHApplication domain(String domain) {
    this.domain = domain;
    return this;
  }
  ...
  **/
  ...
  public BrowserSSHApplication enableBindingCookie(Boolean enableBindingCookie) {
  ...
  **/
  ...
  public BrowserSSHApplication httpOnlyCookieAttribute(Boolean httpOnlyCookieAttribute) {
  ...
  **/
  ...
  public BrowserSSHApplication logoUrl(String logoUrl) {
  ...
  **/
  ...
  public BrowserSSHApplication name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public BrowserSSHApplication optionsPreflightBypass(Boolean optionsPreflightBypass) {
  ...
  **/
  ...
  public BrowserSSHApplication pathCookieAttribute(Boolean pathCookieAttribute) {
  ...
  **/
  ...
  public BrowserSSHApplication sameSiteCookieAttribute(String sameSiteCookieAttribute) {
  ...
  **/
  ...
  public BrowserSSHApplication selfHostedDomains(List<String> selfHostedDomains) {
    this.selfHostedDomains = selfHostedDomains;
    return this;
  }

  public BrowserSSHApplication addSelfHostedDomainsItem(String selfHostedDomainsItem) {
  ...
  **/
  ...
  public BrowserSSHApplication serviceAuth401Redirect(Boolean serviceAuth401Redirect) {
  ...
  **/
  ...
  public BrowserSSHApplication sessionDuration(String sessionDuration) {
  ...
  **/
  ...
  public BrowserSSHApplication skipInterstitial(Boolean skipInterstitial) {
  ...
  **/
  ...
  public BrowserSSHApplication tags(List<String> tags) {
    this.tags = tags;
    return this;
  }

  public BrowserSSHApplication addTagsItem(String tagsItem) {
    if (this.tags == null) {
  ...
  **/
  ...
  public BrowserSSHApplication type(String type) {
    this.type = type;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    BrowserSSHApplication browserSSHApplication = (BrowserSSHApplication) o;
    return Objects.equals(this.aud, browserSSHApplication.aud) &&
        Objects.equals(this.createdAt, browserSSHApplication.createdAt) &&
        Objects.equals(this.id, browserSSHApplication.id) &&
        Objects.equals(this.updatedAt, browserSSHApplication.updatedAt) &&
        Objects.equals(this.allowAuthenticateViaWarp, browserSSHApplication.allowAuthenticateViaWarp) &&
        Objects.equals(this.allowedIdps, browserSSHApplication.allowedIdps) &&
        Objects.equals(this.appLauncherVisible, browserSSHApplication.appLauncherVisible) &&
        Objects.equals(this.autoRedirectToIdentity, browserSSHApplication.autoRedirectToIdentity) &&
        Objects.equals(this.corsHeaders, browserSSHApplication.corsHeaders) &&
        Objects.equals(this.customDenyMessage, browserSSHApplication.customDenyMessage) &&
        Objects.equals(this.customDenyUrl, browserSSHApplication.customDenyUrl) &&
        Objects.equals(this.customNonIdentityDenyUrl, browserSSHApplication.customNonIdentityDenyUrl) &&
        Objects.equals(this.customPages, browserSSHApplication.customPages) &&
        Objects.equals(this.domain, browserSSHApplication.domain) &&
        Objects.equals(this.enableBindingCookie, browserSSHApplication.enableBindingCookie) &&
        Objects.equals(this.httpOnlyCookieAttribute, browserSSHApplication.httpOnlyCookieAttribute) &&
        Objects.equals(this.logoUrl, browserSSHApplication.logoUrl) &&
        Objects.equals(this.name, browserSSHApplication.name) &&
        Objects.equals(this.optionsPreflightBypass, browserSSHApplication.optionsPreflightBypass) &&
        Objects.equals(this.pathCookieAttribute, browserSSHApplication.pathCookieAttribute) &&
        Objects.equals(this.sameSiteCookieAttribute, browserSSHApplication.sameSiteCookieAttribute) &&
        Objects.equals(this.selfHostedDomains, browserSSHApplication.selfHostedDomains) &&
        Objects.equals(this.serviceAuth401Redirect, browserSSHApplication.serviceAuth401Redirect) &&
        Objects.equals(this.sessionDuration, browserSSHApplication.sessionDuration) &&
        Objects.equals(this.skipInterstitial, browserSSHApplication.skipInterstitial) &&
        Objects.equals(this.tags, browserSSHApplication.tags) &&
        Objects.equals(this.type, browserSSHApplication.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class BrowserSSHApplication {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to BrowserSSHApplication
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BrowserSSHApplication.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BrowserSSHApplication is not found in the empty JSON string", BrowserSSHApplication.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BrowserSSHApplication.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BrowserSSHApplication` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : BrowserSSHApplication.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BrowserSSHApplication.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BrowserSSHApplication' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BrowserSSHApplication> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BrowserSSHApplication.class));

       return (TypeAdapter<T>) new TypeAdapter<BrowserSSHApplication>() {
           @Override
           public void write(JsonWriter out, BrowserSSHApplication value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BrowserSSHApplication read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of BrowserSSHApplication given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of BrowserSSHApplication
  * @throws IOException if the JSON string is invalid with respect to BrowserSSHApplication
  */
  public static BrowserSSHApplication fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BrowserSSHApplication.class);
  }

 /**
  * Convert an instance of BrowserSSHApplication to an JSON string
  *
  * @return JSON string
  */
