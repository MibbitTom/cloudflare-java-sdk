...
public class IamUserInvite {
  ...
  **/
  ...
  public IamUserInvite invitedBy(String invitedBy) {
  ...
  **/
  ...
  public IamUserInvite invitedMemberEmail(String invitedMemberEmail) {
  ...
  **/
  ...
  public IamUserInvite roles(List<IamSchemasRole> roles) {
    this.roles = roles;
    return this;
  }

  public IamUserInvite addRolesItem(IamSchemasRole rolesItem) {
    if (this.roles == null) {
  ...
  **/
  ...
  public IamUserInvite status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    IamUserInvite iamUserInvite = (IamUserInvite) o;
    return Objects.equals(this.expiresOn, iamUserInvite.expiresOn) &&
        Objects.equals(this.id, iamUserInvite.id) &&
        Objects.equals(this.invitedBy, iamUserInvite.invitedBy) &&
        Objects.equals(this.invitedMemberEmail, iamUserInvite.invitedMemberEmail) &&
        Objects.equals(this.invitedMemberId, iamUserInvite.invitedMemberId) &&
        Objects.equals(this.invitedOn, iamUserInvite.invitedOn) &&
        Objects.equals(this.organizationId, iamUserInvite.organizationId) &&
        Objects.equals(this.organizationName, iamUserInvite.organizationName) &&
        Objects.equals(this.roles, iamUserInvite.roles) &&
        Objects.equals(this.status, iamUserInvite.status);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to IamUserInvite
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IamUserInvite.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IamUserInvite is not found in the empty JSON string", IamUserInvite.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IamUserInvite.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `IamUserInvite` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : IamUserInvite.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IamUserInvite.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IamUserInvite' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IamUserInvite> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IamUserInvite.class));

       return (TypeAdapter<T>) new TypeAdapter<IamUserInvite>() {
           @Override
           public void write(JsonWriter out, IamUserInvite value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public IamUserInvite read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of IamUserInvite given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of IamUserInvite
  * @throws IOException if the JSON string is invalid with respect to IamUserInvite
  */
  public static IamUserInvite fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IamUserInvite.class);
  }

 /**
  * Convert an instance of IamUserInvite to an JSON string
  *
  * @return JSON string
  */
