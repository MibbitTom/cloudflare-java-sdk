...
public class AccessOrganizations {
  ...
  public AccessOrganizations allowAuthenticateViaWarp(Boolean allowAuthenticateViaWarp) {
  ...
  **/
  ...
  public AccessOrganizations authDomain(String authDomain) {
  ...
  **/
  ...
  public AccessOrganizations autoRedirectToIdentity(Boolean autoRedirectToIdentity) {
  ...
  **/
  ...
  public AccessOrganizations customPages(AccessCustomPages customPages) {
  ...
  **/
  ...
  public AccessOrganizations isUiReadOnly(Boolean isUiReadOnly) {
  ...
  **/
  ...
  public AccessOrganizations loginDesign(AccessLoginDesign loginDesign) {
  ...
  **/
  ...
  public AccessOrganizations name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public AccessOrganizations sessionDuration(String sessionDuration) {
  ...
  **/
  ...
  public AccessOrganizations uiReadOnlyToggleReason(String uiReadOnlyToggleReason) {
  ...
  **/
  ...
  public AccessOrganizations userSeatExpirationInactiveTime(String userSeatExpirationInactiveTime) {
  ...
  **/
  ...
  public AccessOrganizations warpAuthSessionDuration(String warpAuthSessionDuration) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    AccessOrganizations accessOrganizations = (AccessOrganizations) o;
    return Objects.equals(this.allowAuthenticateViaWarp, accessOrganizations.allowAuthenticateViaWarp) &&
        Objects.equals(this.authDomain, accessOrganizations.authDomain) &&
        Objects.equals(this.autoRedirectToIdentity, accessOrganizations.autoRedirectToIdentity) &&
        Objects.equals(this.createdAt, accessOrganizations.createdAt) &&
        Objects.equals(this.customPages, accessOrganizations.customPages) &&
        Objects.equals(this.isUiReadOnly, accessOrganizations.isUiReadOnly) &&
        Objects.equals(this.loginDesign, accessOrganizations.loginDesign) &&
        Objects.equals(this.name, accessOrganizations.name) &&
        Objects.equals(this.sessionDuration, accessOrganizations.sessionDuration) &&
        Objects.equals(this.uiReadOnlyToggleReason, accessOrganizations.uiReadOnlyToggleReason) &&
        Objects.equals(this.updatedAt, accessOrganizations.updatedAt) &&
        Objects.equals(this.userSeatExpirationInactiveTime, accessOrganizations.userSeatExpirationInactiveTime) &&
        Objects.equals(this.warpAuthSessionDuration, accessOrganizations.warpAuthSessionDuration);
  }

  @Override
  public int hashCode() {
    return Objects.hash(allowAuthenticateViaWarp, authDomain, autoRedirectToIdentity, createdAt, customPages, isUiReadOnly, loginDesign, name, sessionDuration, uiReadOnlyToggleReason, updatedAt, userSeatExpirationInactiveTime, warpAuthSessionDuration);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AccessOrganizations {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to AccessOrganizations
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AccessOrganizations.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AccessOrganizations is not found in the empty JSON string", AccessOrganizations.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AccessOrganizations.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AccessOrganizations` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AccessOrganizations.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AccessOrganizations' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AccessOrganizations> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AccessOrganizations.class));

       return (TypeAdapter<T>) new TypeAdapter<AccessOrganizations>() {
           @Override
           public void write(JsonWriter out, AccessOrganizations value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AccessOrganizations read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of AccessOrganizations given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AccessOrganizations
  * @throws IOException if the JSON string is invalid with respect to AccessOrganizations
  */
  public static AccessOrganizations fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AccessOrganizations.class);
  }

 /**
  * Convert an instance of AccessOrganizations to an JSON string
  *
  * @return JSON string
  */
