...
public class WaitingroomWaitingroom {
  ...
  public static final String SERIALIZED_NAME_NEXT_EVENT_PREQUEUE_START_TIME = "next_event_prequeue_start_time";
  @SerializedName(SERIALIZED_NAME_NEXT_EVENT_PREQUEUE_START_TIME)
  private String nextEventPrequeueStartTime;

  public static final String SERIALIZED_NAME_NEXT_EVENT_START_TIME = "next_event_start_time";
  @SerializedName(SERIALIZED_NAME_NEXT_EVENT_START_TIME)
  ...
  public WaitingroomWaitingroom additionalRoutes(List<WaitingroomAdditionalRoutesInner> additionalRoutes) {
    this.additionalRoutes = additionalRoutes;
    return this;
  }

  public WaitingroomWaitingroom addAdditionalRoutesItem(WaitingroomAdditionalRoutesInner additionalRoutesItem) {
  ...
  **/
  ...
  public WaitingroomWaitingroom cookieAttributes(WaitingroomCookieAttributes cookieAttributes) {
  ...
  **/
  ...
  public WaitingroomWaitingroom cookieSuffix(String cookieSuffix) {
  ...
  **/
  ...
  public WaitingroomWaitingroom customPageHtml(String customPageHtml) {
  ...
  **/
  ...
  public WaitingroomWaitingroom defaultTemplateLanguage(WaitingroomDefaultTemplateLanguage defaultTemplateLanguage) {
  ...
  **/
  ...
  public WaitingroomWaitingroom description(String description) {
  ...
  **/
  ...
  public WaitingroomWaitingroom disableSessionRenewal(Boolean disableSessionRenewal) {
  ...
  **/
  ...
  public WaitingroomWaitingroom host(String host) {
    this.host = host;
    return this;
  }
  ...
  **/
  ...
  public WaitingroomWaitingroom id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public WaitingroomWaitingroom jsonResponseEnabled(Boolean jsonResponseEnabled) {
  ...
  **/
  ...
  public WaitingroomWaitingroom name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public WaitingroomWaitingroom newUsersPerMinute(Integer newUsersPerMinute) {
  ...
  **/
  ...
  public WaitingroomWaitingroom nextEventPrequeueStartTime(String nextEventPrequeueStartTime) {
  ...
  **/
  ...
  public WaitingroomWaitingroom nextEventStartTime(String nextEventStartTime) {
  ...
  **/
  ...
  public WaitingroomWaitingroom path(String path) {
    this.path = path;
    return this;
  }
  ...
  **/
  ...
  public WaitingroomWaitingroom queueAll(Boolean queueAll) {
  ...
  **/
  ...
  public WaitingroomWaitingroom queueingMethod(WaitingroomQueueingMethod queueingMethod) {
  ...
  **/
  ...
  public WaitingroomWaitingroom queueingStatusCode(WaitingroomQueueingStatusCode queueingStatusCode) {
  ...
  **/
  ...
  public WaitingroomWaitingroom sessionDuration(Integer sessionDuration) {
  ...
  **/
  ...
  public WaitingroomWaitingroom suspended(Boolean suspended) {
  ...
  **/
  ...
  public WaitingroomWaitingroom totalActiveUsers(Integer totalActiveUsers) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    WaitingroomWaitingroom waitingroomWaitingroom = (WaitingroomWaitingroom) o;
    return Objects.equals(this.additionalRoutes, waitingroomWaitingroom.additionalRoutes) &&
        Objects.equals(this.cookieAttributes, waitingroomWaitingroom.cookieAttributes) &&
        Objects.equals(this.cookieSuffix, waitingroomWaitingroom.cookieSuffix) &&
        Objects.equals(this.createdOn, waitingroomWaitingroom.createdOn) &&
        Objects.equals(this.customPageHtml, waitingroomWaitingroom.customPageHtml) &&
        Objects.equals(this.defaultTemplateLanguage, waitingroomWaitingroom.defaultTemplateLanguage) &&
        Objects.equals(this.description, waitingroomWaitingroom.description) &&
        Objects.equals(this.disableSessionRenewal, waitingroomWaitingroom.disableSessionRenewal) &&
        Objects.equals(this.host, waitingroomWaitingroom.host) &&
        Objects.equals(this.id, waitingroomWaitingroom.id) &&
        Objects.equals(this.jsonResponseEnabled, waitingroomWaitingroom.jsonResponseEnabled) &&
        Objects.equals(this.modifiedOn, waitingroomWaitingroom.modifiedOn) &&
        Objects.equals(this.name, waitingroomWaitingroom.name) &&
        Objects.equals(this.newUsersPerMinute, waitingroomWaitingroom.newUsersPerMinute) &&
        Objects.equals(this.nextEventPrequeueStartTime, waitingroomWaitingroom.nextEventPrequeueStartTime) &&
        Objects.equals(this.nextEventStartTime, waitingroomWaitingroom.nextEventStartTime) &&
        Objects.equals(this.path, waitingroomWaitingroom.path) &&
        Objects.equals(this.queueAll, waitingroomWaitingroom.queueAll) &&
        Objects.equals(this.queueingMethod, waitingroomWaitingroom.queueingMethod) &&
        Objects.equals(this.queueingStatusCode, waitingroomWaitingroom.queueingStatusCode) &&
        Objects.equals(this.sessionDuration, waitingroomWaitingroom.sessionDuration) &&
        Objects.equals(this.suspended, waitingroomWaitingroom.suspended) &&
        Objects.equals(this.totalActiveUsers, waitingroomWaitingroom.totalActiveUsers);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(additionalRoutes, cookieAttributes, cookieSuffix, createdOn, customPageHtml, defaultTemplateLanguage, description, disableSessionRenewal, host, id, jsonResponseEnabled, modifiedOn, name, newUsersPerMinute, nextEventPrequeueStartTime, nextEventStartTime, path, queueAll, queueingMethod, queueingStatusCode, sessionDuration, suspended, totalActiveUsers);
  }
  ...
  public String toString() {
    ...
    sb.append("class WaitingroomWaitingroom {\n");
  ...
  static {
    ...
    openapiFields.add("next_event_prequeue_start_time");
    openapiFields.add("next_event_start_time");
  ...
  * @throws IOException if the JSON Element is invalid with respect to WaitingroomWaitingroom
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WaitingroomWaitingroom.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WaitingroomWaitingroom is not found in the empty JSON string", WaitingroomWaitingroom.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WaitingroomWaitingroom.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WaitingroomWaitingroom` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("next_event_prequeue_start_time") != null && !jsonObj.get("next_event_prequeue_start_time").isJsonNull()) && !jsonObj.get("next_event_prequeue_start_time").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `next_event_prequeue_start_time` to be a primitive type in the JSON string but got `%s`", jsonObj.get("next_event_prequeue_start_time").toString()));
      }
      if ((jsonObj.get("next_event_start_time") != null && !jsonObj.get("next_event_start_time").isJsonNull()) && !jsonObj.get("next_event_start_time").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `next_event_start_time` to be a primitive type in the JSON string but got `%s`", jsonObj.get("next_event_start_time").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WaitingroomWaitingroom.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WaitingroomWaitingroom' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WaitingroomWaitingroom> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WaitingroomWaitingroom.class));

       return (TypeAdapter<T>) new TypeAdapter<WaitingroomWaitingroom>() {
           @Override
           public void write(JsonWriter out, WaitingroomWaitingroom value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WaitingroomWaitingroom read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of WaitingroomWaitingroom given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WaitingroomWaitingroom
  * @throws IOException if the JSON string is invalid with respect to WaitingroomWaitingroom
  */
  public static WaitingroomWaitingroom fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WaitingroomWaitingroom.class);
  }

 /**
  * Convert an instance of WaitingroomWaitingroom to an JSON string
  *
  * @return JSON string
  */
