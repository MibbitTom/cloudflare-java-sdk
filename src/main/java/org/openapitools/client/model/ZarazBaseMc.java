...
public class ZarazBaseMc {
  ...
  public ZarazBaseMc blockingTriggers(List<String> blockingTriggers) {
    this.blockingTriggers = blockingTriggers;
    return this;
  }

  public ZarazBaseMc addBlockingTriggersItem(String blockingTriggersItem) {
  ...
  **/
  ...
  public ZarazBaseMc defaultFields(Map<String, ZarazBaseMcAllOfSettings> defaultFields) {
    this.defaultFields = defaultFields;
    return this;
  }

  public ZarazBaseMc putDefaultFieldsItem(String key, ZarazBaseMcAllOfSettings defaultFieldsItem) {
  ...
  **/
  ...
  public ZarazBaseMc defaultPurpose(String defaultPurpose) {
  ...
  **/
  ...
  public ZarazBaseMc enabled(Boolean enabled) {
  ...
  **/
  ...
  public ZarazBaseMc name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public ZarazBaseMc vendorName(String vendorName) {
  ...
  **/
  ...
  public ZarazBaseMc vendorPolicyUrl(String vendorPolicyUrl) {
  ...
  **/
  ...
  public ZarazBaseMc actions(Map<String, ZarazBaseMcAllOfActions> actions) {
    this.actions = actions;
    return this;
  }

  public ZarazBaseMc putActionsItem(String key, ZarazBaseMcAllOfActions actionsItem) {
  ...
  **/
  ...
  public ZarazBaseMc component(String component) {
  ...
  **/
  ...
  public ZarazBaseMc neoEvents(List<ZarazBaseMcAllOfActions> neoEvents) {
    this.neoEvents = neoEvents;
    return this;
  }

  public ZarazBaseMc addNeoEventsItem(ZarazBaseMcAllOfActions neoEventsItem) {
  ...
  **/
  ...
  public ZarazBaseMc permissions(List<String> permissions) {
    this.permissions = permissions;
    return this;
  }

  public ZarazBaseMc addPermissionsItem(String permissionsItem) {
  ...
  **/
  ...
  public ZarazBaseMc settings(Map<String, ZarazBaseMcAllOfSettings> settings) {
    this.settings = settings;
    return this;
  }

  public ZarazBaseMc putSettingsItem(String key, ZarazBaseMcAllOfSettings settingsItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ZarazBaseMc zarazBaseMc = (ZarazBaseMc) o;
    return Objects.equals(this.blockingTriggers, zarazBaseMc.blockingTriggers) &&
        Objects.equals(this.defaultFields, zarazBaseMc.defaultFields) &&
        Objects.equals(this.defaultPurpose, zarazBaseMc.defaultPurpose) &&
        Objects.equals(this.enabled, zarazBaseMc.enabled) &&
        Objects.equals(this.name, zarazBaseMc.name) &&
        Objects.equals(this.vendorName, zarazBaseMc.vendorName) &&
        Objects.equals(this.vendorPolicyUrl, zarazBaseMc.vendorPolicyUrl) &&
        Objects.equals(this.actions, zarazBaseMc.actions) &&
        Objects.equals(this.component, zarazBaseMc.component) &&
        Objects.equals(this.neoEvents, zarazBaseMc.neoEvents) &&
        Objects.equals(this.permissions, zarazBaseMc.permissions) &&
        Objects.equals(this.settings, zarazBaseMc.settings);
  }

  @Override
  public int hashCode() {
    return Objects.hash(blockingTriggers, defaultFields, defaultPurpose, enabled, name, vendorName, vendorPolicyUrl, actions, component, neoEvents, permissions, settings);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ZarazBaseMc {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to ZarazBaseMc
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ZarazBaseMc.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ZarazBaseMc is not found in the empty JSON string", ZarazBaseMc.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ZarazBaseMc.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ZarazBaseMc` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ZarazBaseMc.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ZarazBaseMc.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ZarazBaseMc' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ZarazBaseMc> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ZarazBaseMc.class));

       return (TypeAdapter<T>) new TypeAdapter<ZarazBaseMc>() {
           @Override
           public void write(JsonWriter out, ZarazBaseMc value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ZarazBaseMc read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ZarazBaseMc given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ZarazBaseMc
  * @throws IOException if the JSON string is invalid with respect to ZarazBaseMc
  */
  public static ZarazBaseMc fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ZarazBaseMc.class);
  }

 /**
  * Convert an instance of ZarazBaseMc to an JSON string
  *
  * @return JSON string
  */
