...
public class Cookie {
  ...
  public Cookie checkPresence(List<String> checkPresence) {
    this.checkPresence = checkPresence;
    return this;
  }

  public Cookie addCheckPresenceItem(String checkPresenceItem) {
  ...
  **/
  ...
  public Cookie include(List<String> include) {
    this.include = include;
    return this;
  }

  public Cookie addIncludeItem(String includeItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.checkPresence, cookie.checkPresence) &&
        Objects.equals(this.include, cookie.include);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to Cookie
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Cookie.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Cookie.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Cookie` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
