...
public class ZeroTrustOrganizationCreateYourZeroTrustOrganizationRequest {
  ...
  public ZeroTrustOrganizationCreateYourZeroTrustOrganizationRequest() {
  }

  public ZeroTrustOrganizationCreateYourZeroTrustOrganizationRequest allowAuthenticateViaWarp(Boolean allowAuthenticateViaWarp) {
  ...
  **/
  ...
  public ZeroTrustOrganizationCreateYourZeroTrustOrganizationRequest authDomain(String authDomain) {
  ...
  **/
  ...
  public ZeroTrustOrganizationCreateYourZeroTrustOrganizationRequest autoRedirectToIdentity(Boolean autoRedirectToIdentity) {
  ...
  **/
  ...
  public ZeroTrustOrganizationCreateYourZeroTrustOrganizationRequest isUiReadOnly(Boolean isUiReadOnly) {
  ...
  **/
  ...
  public ZeroTrustOrganizationCreateYourZeroTrustOrganizationRequest loginDesign(AccessLoginDesign loginDesign) {
  ...
  **/
  ...
  public ZeroTrustOrganizationCreateYourZeroTrustOrganizationRequest name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public ZeroTrustOrganizationCreateYourZeroTrustOrganizationRequest sessionDuration(String sessionDuration) {
  ...
  **/
  ...
  public ZeroTrustOrganizationCreateYourZeroTrustOrganizationRequest uiReadOnlyToggleReason(String uiReadOnlyToggleReason) {
  ...
  **/
  ...
  public ZeroTrustOrganizationCreateYourZeroTrustOrganizationRequest userSeatExpirationInactiveTime(String userSeatExpirationInactiveTime) {
  ...
  **/
  ...
  public ZeroTrustOrganizationCreateYourZeroTrustOrganizationRequest warpAuthSessionDuration(String warpAuthSessionDuration) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ZeroTrustOrganizationCreateYourZeroTrustOrganizationRequest zeroTrustOrganizationCreateYourZeroTrustOrganizationRequest = (ZeroTrustOrganizationCreateYourZeroTrustOrganizationRequest) o;
    return Objects.equals(this.allowAuthenticateViaWarp, zeroTrustOrganizationCreateYourZeroTrustOrganizationRequest.allowAuthenticateViaWarp) &&
        Objects.equals(this.authDomain, zeroTrustOrganizationCreateYourZeroTrustOrganizationRequest.authDomain) &&
        Objects.equals(this.autoRedirectToIdentity, zeroTrustOrganizationCreateYourZeroTrustOrganizationRequest.autoRedirectToIdentity) &&
        Objects.equals(this.isUiReadOnly, zeroTrustOrganizationCreateYourZeroTrustOrganizationRequest.isUiReadOnly) &&
        Objects.equals(this.loginDesign, zeroTrustOrganizationCreateYourZeroTrustOrganizationRequest.loginDesign) &&
        Objects.equals(this.name, zeroTrustOrganizationCreateYourZeroTrustOrganizationRequest.name) &&
        Objects.equals(this.sessionDuration, zeroTrustOrganizationCreateYourZeroTrustOrganizationRequest.sessionDuration) &&
        Objects.equals(this.uiReadOnlyToggleReason, zeroTrustOrganizationCreateYourZeroTrustOrganizationRequest.uiReadOnlyToggleReason) &&
        Objects.equals(this.userSeatExpirationInactiveTime, zeroTrustOrganizationCreateYourZeroTrustOrganizationRequest.userSeatExpirationInactiveTime) &&
        Objects.equals(this.warpAuthSessionDuration, zeroTrustOrganizationCreateYourZeroTrustOrganizationRequest.warpAuthSessionDuration);
  }

  @Override
  public int hashCode() {
    return Objects.hash(allowAuthenticateViaWarp, authDomain, autoRedirectToIdentity, isUiReadOnly, loginDesign, name, sessionDuration, uiReadOnlyToggleReason, userSeatExpirationInactiveTime, warpAuthSessionDuration);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ZeroTrustOrganizationCreateYourZeroTrustOrganizationRequest {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to ZeroTrustOrganizationCreateYourZeroTrustOrganizationRequest
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ZeroTrustOrganizationCreateYourZeroTrustOrganizationRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ZeroTrustOrganizationCreateYourZeroTrustOrganizationRequest is not found in the empty JSON string", ZeroTrustOrganizationCreateYourZeroTrustOrganizationRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ZeroTrustOrganizationCreateYourZeroTrustOrganizationRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ZeroTrustOrganizationCreateYourZeroTrustOrganizationRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ZeroTrustOrganizationCreateYourZeroTrustOrganizationRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ZeroTrustOrganizationCreateYourZeroTrustOrganizationRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ZeroTrustOrganizationCreateYourZeroTrustOrganizationRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ZeroTrustOrganizationCreateYourZeroTrustOrganizationRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ZeroTrustOrganizationCreateYourZeroTrustOrganizationRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ZeroTrustOrganizationCreateYourZeroTrustOrganizationRequest>() {
           @Override
           public void write(JsonWriter out, ZeroTrustOrganizationCreateYourZeroTrustOrganizationRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ZeroTrustOrganizationCreateYourZeroTrustOrganizationRequest read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ZeroTrustOrganizationCreateYourZeroTrustOrganizationRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ZeroTrustOrganizationCreateYourZeroTrustOrganizationRequest
  * @throws IOException if the JSON string is invalid with respect to ZeroTrustOrganizationCreateYourZeroTrustOrganizationRequest
  */
  public static ZeroTrustOrganizationCreateYourZeroTrustOrganizationRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ZeroTrustOrganizationCreateYourZeroTrustOrganizationRequest.class);
  }

 /**
  * Convert an instance of ZeroTrustOrganizationCreateYourZeroTrustOrganizationRequest to an JSON string
  *
  * @return JSON string
  */
