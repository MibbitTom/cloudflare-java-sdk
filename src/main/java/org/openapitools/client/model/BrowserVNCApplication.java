...
public class BrowserVNCApplication {
  ...
  **/
  ...
  public BrowserVNCApplication allowAuthenticateViaWarp(Boolean allowAuthenticateViaWarp) {
  ...
  **/
  ...
  public BrowserVNCApplication allowedIdps(List<String> allowedIdps) {
    this.allowedIdps = allowedIdps;
    return this;
  }

  public BrowserVNCApplication addAllowedIdpsItem(String allowedIdpsItem) {
  ...
  **/
  ...
  public BrowserVNCApplication appLauncherVisible(Boolean appLauncherVisible) {
  ...
  **/
  ...
  public BrowserVNCApplication autoRedirectToIdentity(Boolean autoRedirectToIdentity) {
  ...
  **/
  ...
  public BrowserVNCApplication corsHeaders(AccessCorsHeaders corsHeaders) {
  ...
  **/
  ...
  public BrowserVNCApplication customDenyMessage(String customDenyMessage) {
  ...
  **/
  ...
  public BrowserVNCApplication customDenyUrl(String customDenyUrl) {
  ...
  **/
  ...
  public BrowserVNCApplication customNonIdentityDenyUrl(String customNonIdentityDenyUrl) {
  ...
  **/
  ...
  public BrowserVNCApplication customPages(List<String> customPages) {
    this.customPages = customPages;
    return this;
  }

  public BrowserVNCApplication addCustomPagesItem(String customPagesItem) {
  ...
  **/
  ...
  public BrowserVNCApplication domain(String domain) {
    this.domain = domain;
    return this;
  }
  ...
  **/
  ...
  public BrowserVNCApplication enableBindingCookie(Boolean enableBindingCookie) {
  ...
  **/
  ...
  public BrowserVNCApplication httpOnlyCookieAttribute(Boolean httpOnlyCookieAttribute) {
  ...
  **/
  ...
  public BrowserVNCApplication logoUrl(String logoUrl) {
  ...
  **/
  ...
  public BrowserVNCApplication name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public BrowserVNCApplication optionsPreflightBypass(Boolean optionsPreflightBypass) {
  ...
  **/
  ...
  public BrowserVNCApplication pathCookieAttribute(Boolean pathCookieAttribute) {
  ...
  **/
  ...
  public BrowserVNCApplication sameSiteCookieAttribute(String sameSiteCookieAttribute) {
  ...
  **/
  ...
  public BrowserVNCApplication selfHostedDomains(List<String> selfHostedDomains) {
    this.selfHostedDomains = selfHostedDomains;
    return this;
  }

  public BrowserVNCApplication addSelfHostedDomainsItem(String selfHostedDomainsItem) {
  ...
  **/
  ...
  public BrowserVNCApplication serviceAuth401Redirect(Boolean serviceAuth401Redirect) {
  ...
  **/
  ...
  public BrowserVNCApplication sessionDuration(String sessionDuration) {
  ...
  **/
  ...
  public BrowserVNCApplication skipInterstitial(Boolean skipInterstitial) {
  ...
  **/
  ...
  public BrowserVNCApplication tags(List<String> tags) {
    this.tags = tags;
    return this;
  }

  public BrowserVNCApplication addTagsItem(String tagsItem) {
    if (this.tags == null) {
  ...
  **/
  ...
  public BrowserVNCApplication type(String type) {
    this.type = type;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    BrowserVNCApplication browserVNCApplication = (BrowserVNCApplication) o;
    return Objects.equals(this.aud, browserVNCApplication.aud) &&
        Objects.equals(this.createdAt, browserVNCApplication.createdAt) &&
        Objects.equals(this.id, browserVNCApplication.id) &&
        Objects.equals(this.updatedAt, browserVNCApplication.updatedAt) &&
        Objects.equals(this.allowAuthenticateViaWarp, browserVNCApplication.allowAuthenticateViaWarp) &&
        Objects.equals(this.allowedIdps, browserVNCApplication.allowedIdps) &&
        Objects.equals(this.appLauncherVisible, browserVNCApplication.appLauncherVisible) &&
        Objects.equals(this.autoRedirectToIdentity, browserVNCApplication.autoRedirectToIdentity) &&
        Objects.equals(this.corsHeaders, browserVNCApplication.corsHeaders) &&
        Objects.equals(this.customDenyMessage, browserVNCApplication.customDenyMessage) &&
        Objects.equals(this.customDenyUrl, browserVNCApplication.customDenyUrl) &&
        Objects.equals(this.customNonIdentityDenyUrl, browserVNCApplication.customNonIdentityDenyUrl) &&
        Objects.equals(this.customPages, browserVNCApplication.customPages) &&
        Objects.equals(this.domain, browserVNCApplication.domain) &&
        Objects.equals(this.enableBindingCookie, browserVNCApplication.enableBindingCookie) &&
        Objects.equals(this.httpOnlyCookieAttribute, browserVNCApplication.httpOnlyCookieAttribute) &&
        Objects.equals(this.logoUrl, browserVNCApplication.logoUrl) &&
        Objects.equals(this.name, browserVNCApplication.name) &&
        Objects.equals(this.optionsPreflightBypass, browserVNCApplication.optionsPreflightBypass) &&
        Objects.equals(this.pathCookieAttribute, browserVNCApplication.pathCookieAttribute) &&
        Objects.equals(this.sameSiteCookieAttribute, browserVNCApplication.sameSiteCookieAttribute) &&
        Objects.equals(this.selfHostedDomains, browserVNCApplication.selfHostedDomains) &&
        Objects.equals(this.serviceAuth401Redirect, browserVNCApplication.serviceAuth401Redirect) &&
        Objects.equals(this.sessionDuration, browserVNCApplication.sessionDuration) &&
        Objects.equals(this.skipInterstitial, browserVNCApplication.skipInterstitial) &&
        Objects.equals(this.tags, browserVNCApplication.tags) &&
        Objects.equals(this.type, browserVNCApplication.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class BrowserVNCApplication {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to BrowserVNCApplication
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BrowserVNCApplication.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BrowserVNCApplication is not found in the empty JSON string", BrowserVNCApplication.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BrowserVNCApplication.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BrowserVNCApplication` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : BrowserVNCApplication.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BrowserVNCApplication.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BrowserVNCApplication' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BrowserVNCApplication> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BrowserVNCApplication.class));

       return (TypeAdapter<T>) new TypeAdapter<BrowserVNCApplication>() {
           @Override
           public void write(JsonWriter out, BrowserVNCApplication value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BrowserVNCApplication read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of BrowserVNCApplication given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of BrowserVNCApplication
  * @throws IOException if the JSON string is invalid with respect to BrowserVNCApplication
  */
  public static BrowserVNCApplication fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BrowserVNCApplication.class);
  }

 /**
  * Convert an instance of BrowserVNCApplication to an JSON string
  *
  * @return JSON string
  */
