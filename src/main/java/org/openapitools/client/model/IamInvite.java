...
public class IamInvite {
  ...
  **/
  ...
  public IamInvite invitedBy(String invitedBy) {
  ...
  **/
  ...
  public IamInvite invitedMemberEmail(String invitedMemberEmail) {
  ...
  **/
  ...
  public IamInvite roles(List<IamSchemasRole> roles) {
    this.roles = roles;
    return this;
  }

  public IamInvite addRolesItem(IamSchemasRole rolesItem) {
    if (this.roles == null) {
  ...
  **/
  ...
  public IamInvite organizationIsEnforcingTwofactor(Boolean organizationIsEnforcingTwofactor) {
  ...
  **/
  ...
  public IamInvite status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    IamInvite iamInvite = (IamInvite) o;
    return Objects.equals(this.expiresOn, iamInvite.expiresOn) &&
        Objects.equals(this.id, iamInvite.id) &&
        Objects.equals(this.invitedBy, iamInvite.invitedBy) &&
        Objects.equals(this.invitedMemberEmail, iamInvite.invitedMemberEmail) &&
        Objects.equals(this.invitedMemberId, iamInvite.invitedMemberId) &&
        Objects.equals(this.invitedOn, iamInvite.invitedOn) &&
        Objects.equals(this.organizationId, iamInvite.organizationId) &&
        Objects.equals(this.organizationName, iamInvite.organizationName) &&
        Objects.equals(this.roles, iamInvite.roles) &&
        Objects.equals(this.organizationIsEnforcingTwofactor, iamInvite.organizationIsEnforcingTwofactor) &&
        Objects.equals(this.status, iamInvite.status);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to IamInvite
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IamInvite.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IamInvite is not found in the empty JSON string", IamInvite.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IamInvite.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `IamInvite` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : IamInvite.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IamInvite.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IamInvite' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IamInvite> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IamInvite.class));

       return (TypeAdapter<T>) new TypeAdapter<IamInvite>() {
           @Override
           public void write(JsonWriter out, IamInvite value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public IamInvite read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of IamInvite given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of IamInvite
  * @throws IOException if the JSON string is invalid with respect to IamInvite
  */
  public static IamInvite fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IamInvite.class);
  }

 /**
  * Convert an instance of IamInvite to an JSON string
  *
  * @return JSON string
  */
