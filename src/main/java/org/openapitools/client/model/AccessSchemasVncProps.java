...
public class AccessSchemasVncProps {
  ...
  public AccessSchemasVncProps() {
  }

  public AccessSchemasVncProps allowedIdps(List<String> allowedIdps) {
    this.allowedIdps = allowedIdps;
    return this;
  }

  public AccessSchemasVncProps addAllowedIdpsItem(String allowedIdpsItem) {
  ...
  **/
  ...
  public AccessSchemasVncProps appLauncherVisible(Boolean appLauncherVisible) {
  ...
  **/
  ...
  public AccessSchemasVncProps autoRedirectToIdentity(Boolean autoRedirectToIdentity) {
  ...
  **/
  ...
  public AccessSchemasVncProps corsHeaders(AccessSchemasCorsHeaders corsHeaders) {
  ...
  **/
  ...
  public AccessSchemasVncProps customDenyMessage(String customDenyMessage) {
  ...
  **/
  ...
  public AccessSchemasVncProps customDenyUrl(String customDenyUrl) {
  ...
  **/
  ...
  public AccessSchemasVncProps domain(String domain) {
    this.domain = domain;
    return this;
  }
  ...
  **/
  ...
  public AccessSchemasVncProps enableBindingCookie(Boolean enableBindingCookie) {
  ...
  **/
  ...
  public AccessSchemasVncProps httpOnlyCookieAttribute(Boolean httpOnlyCookieAttribute) {
  ...
  **/
  ...
  public AccessSchemasVncProps logoUrl(String logoUrl) {
  ...
  **/
  ...
  public AccessSchemasVncProps name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public AccessSchemasVncProps optionsPreflightBypass(Boolean optionsPreflightBypass) {
  ...
  **/
  ...
  public AccessSchemasVncProps sameSiteCookieAttribute(String sameSiteCookieAttribute) {
  ...
  **/
  ...
  public AccessSchemasVncProps serviceAuth401Redirect(Boolean serviceAuth401Redirect) {
  ...
  **/
  ...
  public AccessSchemasVncProps sessionDuration(String sessionDuration) {
  ...
  **/
  ...
  public AccessSchemasVncProps skipInterstitial(Boolean skipInterstitial) {
  ...
  **/
  ...
  public AccessSchemasVncProps type(String type) {
    this.type = type;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    AccessSchemasVncProps accessSchemasVncProps = (AccessSchemasVncProps) o;
    return Objects.equals(this.allowedIdps, accessSchemasVncProps.allowedIdps) &&
        Objects.equals(this.appLauncherVisible, accessSchemasVncProps.appLauncherVisible) &&
        Objects.equals(this.autoRedirectToIdentity, accessSchemasVncProps.autoRedirectToIdentity) &&
        Objects.equals(this.corsHeaders, accessSchemasVncProps.corsHeaders) &&
        Objects.equals(this.customDenyMessage, accessSchemasVncProps.customDenyMessage) &&
        Objects.equals(this.customDenyUrl, accessSchemasVncProps.customDenyUrl) &&
        Objects.equals(this.domain, accessSchemasVncProps.domain) &&
        Objects.equals(this.enableBindingCookie, accessSchemasVncProps.enableBindingCookie) &&
        Objects.equals(this.httpOnlyCookieAttribute, accessSchemasVncProps.httpOnlyCookieAttribute) &&
        Objects.equals(this.logoUrl, accessSchemasVncProps.logoUrl) &&
        Objects.equals(this.name, accessSchemasVncProps.name) &&
        Objects.equals(this.optionsPreflightBypass, accessSchemasVncProps.optionsPreflightBypass) &&
        Objects.equals(this.sameSiteCookieAttribute, accessSchemasVncProps.sameSiteCookieAttribute) &&
        Objects.equals(this.serviceAuth401Redirect, accessSchemasVncProps.serviceAuth401Redirect) &&
        Objects.equals(this.sessionDuration, accessSchemasVncProps.sessionDuration) &&
        Objects.equals(this.skipInterstitial, accessSchemasVncProps.skipInterstitial) &&
        Objects.equals(this.type, accessSchemasVncProps.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class AccessSchemasVncProps {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to AccessSchemasVncProps
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AccessSchemasVncProps.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AccessSchemasVncProps is not found in the empty JSON string", AccessSchemasVncProps.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AccessSchemasVncProps.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AccessSchemasVncProps` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AccessSchemasVncProps.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AccessSchemasVncProps.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AccessSchemasVncProps' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AccessSchemasVncProps> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AccessSchemasVncProps.class));

       return (TypeAdapter<T>) new TypeAdapter<AccessSchemasVncProps>() {
           @Override
           public void write(JsonWriter out, AccessSchemasVncProps value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AccessSchemasVncProps read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of AccessSchemasVncProps given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AccessSchemasVncProps
  * @throws IOException if the JSON string is invalid with respect to AccessSchemasVncProps
  */
  public static AccessSchemasVncProps fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AccessSchemasVncProps.class);
  }

 /**
  * Convert an instance of AccessSchemasVncProps to an JSON string
  *
  * @return JSON string
  */
