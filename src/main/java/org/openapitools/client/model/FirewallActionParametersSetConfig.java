...
import org.openapitools.client.model.FirewallActionParametersSetConfigAutominify;
...
public class FirewallActionParametersSetConfig {
  ...
  private FirewallActionParametersSetConfigAutominify autominify;
  ...
  public static final String SERIALIZED_NAME_DISABLE_RAILGUN = "disable_railgun";
  @SerializedName(SERIALIZED_NAME_DISABLE_RAILGUN)
  ...
  public FirewallActionParametersSetConfig() {
  }

  public FirewallActionParametersSetConfig automaticHttpsRewrites(Boolean automaticHttpsRewrites) {
  ...
  **/
  ...
  public FirewallActionParametersSetConfig autominify(FirewallActionParametersSetConfigAutominify autominify) {
  ...
  **/
  @javax.annotation.Nullable
  public FirewallActionParametersSetConfigAutominify getAutominify() {
    return autominify;
  }

  public void setAutominify(FirewallActionParametersSetConfigAutominify autominify) {
    this.autominify = autominify;
  }


  public FirewallActionParametersSetConfig bic(Boolean bic) {
    this.bic = bic;
    return this;
  }
  ...
  **/
  ...
  public FirewallActionParametersSetConfig disableApps(Boolean disableApps) {
  ...
  **/
  ...
  public FirewallActionParametersSetConfig disableRailgun(Boolean disableRailgun) {
  ...
  **/
  @javax.annotation.Nullable
  public Boolean getDisableRailgun() {
    return disableRailgun;
  }
  ...
  public FirewallActionParametersSetConfig disableZaraz(Boolean disableZaraz) {
  ...
  **/
  ...
  public FirewallActionParametersSetConfig emailObfuscation(Boolean emailObfuscation) {
  ...
  **/
  ...
  public FirewallActionParametersSetConfig hotlinkProtection(Boolean hotlinkProtection) {
  ...
  **/
  ...
  public FirewallActionParametersSetConfig mirage(Boolean mirage) {
    this.mirage = mirage;
    return this;
  }
  ...
  **/
  ...
  public FirewallActionParametersSetConfig opportunisticEncryption(Boolean opportunisticEncryption) {
  ...
  **/
  ...
  public FirewallActionParametersSetConfig polish(String polish) {
    this.polish = polish;
    return this;
  }
  ...
  **/
  ...
  public FirewallActionParametersSetConfig rocketLoader(Boolean rocketLoader) {
  ...
  **/
  ...
  public FirewallActionParametersSetConfig securityLevel(String securityLevel) {
  ...
  **/
  ...
  public FirewallActionParametersSetConfig serverSideExcludes(Boolean serverSideExcludes) {
  ...
  **/
  ...
  public FirewallActionParametersSetConfig ssl(String ssl) {
    this.ssl = ssl;
    return this;
  }
  ...
  **/
  ...
  public FirewallActionParametersSetConfig sxg(Boolean sxg) {
    this.sxg = sxg;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    FirewallActionParametersSetConfig firewallActionParametersSetConfig = (FirewallActionParametersSetConfig) o;
    return Objects.equals(this.automaticHttpsRewrites, firewallActionParametersSetConfig.automaticHttpsRewrites) &&
        Objects.equals(this.autominify, firewallActionParametersSetConfig.autominify) &&
        Objects.equals(this.bic, firewallActionParametersSetConfig.bic) &&
        Objects.equals(this.disableApps, firewallActionParametersSetConfig.disableApps) &&
        Objects.equals(this.disableRailgun, firewallActionParametersSetConfig.disableRailgun) &&
        Objects.equals(this.disableZaraz, firewallActionParametersSetConfig.disableZaraz) &&
        Objects.equals(this.emailObfuscation, firewallActionParametersSetConfig.emailObfuscation) &&
        Objects.equals(this.hotlinkProtection, firewallActionParametersSetConfig.hotlinkProtection) &&
        Objects.equals(this.mirage, firewallActionParametersSetConfig.mirage) &&
        Objects.equals(this.opportunisticEncryption, firewallActionParametersSetConfig.opportunisticEncryption) &&
        Objects.equals(this.polish, firewallActionParametersSetConfig.polish) &&
        Objects.equals(this.rocketLoader, firewallActionParametersSetConfig.rocketLoader) &&
        Objects.equals(this.securityLevel, firewallActionParametersSetConfig.securityLevel) &&
        Objects.equals(this.serverSideExcludes, firewallActionParametersSetConfig.serverSideExcludes) &&
        Objects.equals(this.ssl, firewallActionParametersSetConfig.ssl) &&
        Objects.equals(this.sxg, firewallActionParametersSetConfig.sxg);
  }
  ...
  public String toString() {
    ...
    sb.append("class FirewallActionParametersSetConfig {\n");
  ...
  static {
    ...
    openapiFields.add("disable_railgun");
  ...
  * @throws IOException if the JSON Element is invalid with respect to FirewallActionParametersSetConfig
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FirewallActionParametersSetConfig.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FirewallActionParametersSetConfig is not found in the empty JSON string", FirewallActionParametersSetConfig.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FirewallActionParametersSetConfig.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FirewallActionParametersSetConfig` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `autominify`
      if (jsonObj.get("autominify") != null && !jsonObj.get("autominify").isJsonNull()) {
        FirewallActionParametersSetConfigAutominify.validateJsonElement(jsonObj.get("autominify"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FirewallActionParametersSetConfig.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FirewallActionParametersSetConfig' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FirewallActionParametersSetConfig> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FirewallActionParametersSetConfig.class));

       return (TypeAdapter<T>) new TypeAdapter<FirewallActionParametersSetConfig>() {
           @Override
           public void write(JsonWriter out, FirewallActionParametersSetConfig value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FirewallActionParametersSetConfig read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of FirewallActionParametersSetConfig given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FirewallActionParametersSetConfig
  * @throws IOException if the JSON string is invalid with respect to FirewallActionParametersSetConfig
  */
  public static FirewallActionParametersSetConfig fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FirewallActionParametersSetConfig.class);
  }

 /**
  * Convert an instance of FirewallActionParametersSetConfig to an JSON string
  *
  * @return JSON string
  */
