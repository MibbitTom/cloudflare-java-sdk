...
public class IamSchemasInvite {
  ...
  **/
  ...
  public IamSchemasInvite invitedBy(String invitedBy) {
  ...
  **/
  ...
  public IamSchemasInvite invitedMemberEmail(String invitedMemberEmail) {
  ...
  **/
  ...
  public IamSchemasInvite roles(List<IamSchemasRole> roles) {
    this.roles = roles;
    return this;
  }

  public IamSchemasInvite addRolesItem(IamSchemasRole rolesItem) {
    if (this.roles == null) {
  ...
  **/
  ...
  public IamSchemasInvite status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    IamSchemasInvite iamSchemasInvite = (IamSchemasInvite) o;
    return Objects.equals(this.expiresOn, iamSchemasInvite.expiresOn) &&
        Objects.equals(this.id, iamSchemasInvite.id) &&
        Objects.equals(this.invitedBy, iamSchemasInvite.invitedBy) &&
        Objects.equals(this.invitedMemberEmail, iamSchemasInvite.invitedMemberEmail) &&
        Objects.equals(this.invitedMemberId, iamSchemasInvite.invitedMemberId) &&
        Objects.equals(this.invitedOn, iamSchemasInvite.invitedOn) &&
        Objects.equals(this.organizationId, iamSchemasInvite.organizationId) &&
        Objects.equals(this.organizationName, iamSchemasInvite.organizationName) &&
        Objects.equals(this.roles, iamSchemasInvite.roles) &&
        Objects.equals(this.status, iamSchemasInvite.status);
  }

  @Override
  public int hashCode() {
    return Objects.hash(expiresOn, id, invitedBy, invitedMemberEmail, invitedMemberId, invitedOn, organizationId, organizationName, roles, status);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class IamSchemasInvite {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to IamSchemasInvite
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IamSchemasInvite.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IamSchemasInvite is not found in the empty JSON string", IamSchemasInvite.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IamSchemasInvite.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `IamSchemasInvite` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : IamSchemasInvite.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IamSchemasInvite.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IamSchemasInvite' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IamSchemasInvite> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IamSchemasInvite.class));

       return (TypeAdapter<T>) new TypeAdapter<IamSchemasInvite>() {
           @Override
           public void write(JsonWriter out, IamSchemasInvite value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public IamSchemasInvite read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of IamSchemasInvite given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of IamSchemasInvite
  * @throws IOException if the JSON string is invalid with respect to IamSchemasInvite
  */
  public static IamSchemasInvite fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IamSchemasInvite.class);
  }

 /**
  * Convert an instance of IamSchemasInvite to an JSON string
  *
  * @return JSON string
  */
