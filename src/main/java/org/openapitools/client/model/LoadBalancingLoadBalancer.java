...
public class LoadBalancingLoadBalancer {
  ...
  public LoadBalancingLoadBalancer() {
  }
  ...
  public LoadBalancingLoadBalancer adaptiveRouting(LoadBalancingAdaptiveRouting adaptiveRouting) {
  ...
  **/
  ...
  public LoadBalancingLoadBalancer countryPools(Object countryPools) {
  ...
  **/
  ...
  public LoadBalancingLoadBalancer defaultPools(List<String> defaultPools) {
    this.defaultPools = defaultPools;
    return this;
  }

  public LoadBalancingLoadBalancer addDefaultPoolsItem(String defaultPoolsItem) {
  ...
  **/
  ...
  public LoadBalancingLoadBalancer description(String description) {
  ...
  **/
  ...
  public LoadBalancingLoadBalancer enabled(Boolean enabled) {
  ...
  **/
  ...
  public LoadBalancingLoadBalancer fallbackPool(Object fallbackPool) {
  ...
  **/
  ...
  public LoadBalancingLoadBalancer id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public LoadBalancingLoadBalancer locationStrategy(LoadBalancingLocationStrategy locationStrategy) {
  ...
  **/
  ...
  public LoadBalancingLoadBalancer name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public LoadBalancingLoadBalancer popPools(Object popPools) {
  ...
  **/
  ...
  public LoadBalancingLoadBalancer proxied(Boolean proxied) {
  ...
  **/
  ...
  public LoadBalancingLoadBalancer randomSteering(LoadBalancingRandomSteering randomSteering) {
  ...
  **/
  ...
  public LoadBalancingLoadBalancer regionPools(Object regionPools) {
  ...
  **/
  ...
  public LoadBalancingLoadBalancer rules(List<LoadBalancingRulesInner> rules) {
    this.rules = rules;
    return this;
  }

  public LoadBalancingLoadBalancer addRulesItem(LoadBalancingRulesInner rulesItem) {
    if (this.rules == null) {
  ...
  **/
  ...
  public LoadBalancingLoadBalancer sessionAffinity(LoadBalancingSessionAffinity sessionAffinity) {
  ...
  **/
  ...
  public LoadBalancingLoadBalancer sessionAffinityAttributes(LoadBalancingSessionAffinityAttributes sessionAffinityAttributes) {
  ...
  **/
  ...
  public LoadBalancingLoadBalancer sessionAffinityTtl(BigDecimal sessionAffinityTtl) {
  ...
  **/
  ...
  public LoadBalancingLoadBalancer steeringPolicy(LoadBalancingSteeringPolicy steeringPolicy) {
  ...
  **/
  ...
  public LoadBalancingLoadBalancer ttl(BigDecimal ttl) {
    this.ttl = ttl;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    LoadBalancingLoadBalancer loadBalancingLoadBalancer = (LoadBalancingLoadBalancer) o;
    return Objects.equals(this.adaptiveRouting, loadBalancingLoadBalancer.adaptiveRouting) &&
        Objects.equals(this.countryPools, loadBalancingLoadBalancer.countryPools) &&
        Objects.equals(this.createdOn, loadBalancingLoadBalancer.createdOn) &&
        Objects.equals(this.defaultPools, loadBalancingLoadBalancer.defaultPools) &&
        Objects.equals(this.description, loadBalancingLoadBalancer.description) &&
        Objects.equals(this.enabled, loadBalancingLoadBalancer.enabled) &&
        Objects.equals(this.fallbackPool, loadBalancingLoadBalancer.fallbackPool) &&
        Objects.equals(this.id, loadBalancingLoadBalancer.id) &&
        Objects.equals(this.locationStrategy, loadBalancingLoadBalancer.locationStrategy) &&
        Objects.equals(this.modifiedOn, loadBalancingLoadBalancer.modifiedOn) &&
        Objects.equals(this.name, loadBalancingLoadBalancer.name) &&
        Objects.equals(this.popPools, loadBalancingLoadBalancer.popPools) &&
        Objects.equals(this.proxied, loadBalancingLoadBalancer.proxied) &&
        Objects.equals(this.randomSteering, loadBalancingLoadBalancer.randomSteering) &&
        Objects.equals(this.regionPools, loadBalancingLoadBalancer.regionPools) &&
        Objects.equals(this.rules, loadBalancingLoadBalancer.rules) &&
        Objects.equals(this.sessionAffinity, loadBalancingLoadBalancer.sessionAffinity) &&
        Objects.equals(this.sessionAffinityAttributes, loadBalancingLoadBalancer.sessionAffinityAttributes) &&
        Objects.equals(this.sessionAffinityTtl, loadBalancingLoadBalancer.sessionAffinityTtl) &&
        Objects.equals(this.steeringPolicy, loadBalancingLoadBalancer.steeringPolicy) &&
        Objects.equals(this.ttl, loadBalancingLoadBalancer.ttl);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(adaptiveRouting, countryPools, createdOn, defaultPools, description, enabled, fallbackPool, id, locationStrategy, modifiedOn, name, popPools, proxied, randomSteering, regionPools, rules, sessionAffinity, sessionAffinityAttributes, sessionAffinityTtl, steeringPolicy, ttl);
  }
  ...
  public String toString() {
    ...
    sb.append("class LoadBalancingLoadBalancer {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to LoadBalancingLoadBalancer
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LoadBalancingLoadBalancer.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LoadBalancingLoadBalancer is not found in the empty JSON string", LoadBalancingLoadBalancer.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LoadBalancingLoadBalancer.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LoadBalancingLoadBalancer` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LoadBalancingLoadBalancer.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LoadBalancingLoadBalancer' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LoadBalancingLoadBalancer> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LoadBalancingLoadBalancer.class));

       return (TypeAdapter<T>) new TypeAdapter<LoadBalancingLoadBalancer>() {
           @Override
           public void write(JsonWriter out, LoadBalancingLoadBalancer value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LoadBalancingLoadBalancer read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of LoadBalancingLoadBalancer given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LoadBalancingLoadBalancer
  * @throws IOException if the JSON string is invalid with respect to LoadBalancingLoadBalancer
  */
  public static LoadBalancingLoadBalancer fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LoadBalancingLoadBalancer.class);
  }

 /**
  * Convert an instance of LoadBalancingLoadBalancer to an JSON string
  *
  * @return JSON string
  */
