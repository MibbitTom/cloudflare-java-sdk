...
public class SelfHostedApplication1 {
  ...
  **/
  ...
  public SelfHostedApplication1 allowedIdps(List<String> allowedIdps) {
    this.allowedIdps = allowedIdps;
    return this;
  }

  public SelfHostedApplication1 addAllowedIdpsItem(String allowedIdpsItem) {
  ...
  **/
  ...
  public SelfHostedApplication1 appLauncherVisible(Boolean appLauncherVisible) {
  ...
  **/
  ...
  public SelfHostedApplication1 autoRedirectToIdentity(Boolean autoRedirectToIdentity) {
  ...
  **/
  ...
  public SelfHostedApplication1 corsHeaders(AccessSchemasCorsHeaders corsHeaders) {
  ...
  **/
  ...
  public SelfHostedApplication1 customDenyMessage(String customDenyMessage) {
  ...
  **/
  ...
  public SelfHostedApplication1 customDenyUrl(String customDenyUrl) {
  ...
  **/
  ...
  public SelfHostedApplication1 domain(String domain) {
    this.domain = domain;
    return this;
  }
  ...
  **/
  ...
  public SelfHostedApplication1 enableBindingCookie(Boolean enableBindingCookie) {
  ...
  **/
  ...
  public SelfHostedApplication1 httpOnlyCookieAttribute(Boolean httpOnlyCookieAttribute) {
  ...
  **/
  ...
  public SelfHostedApplication1 logoUrl(String logoUrl) {
  ...
  **/
  ...
  public SelfHostedApplication1 name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public SelfHostedApplication1 optionsPreflightBypass(Boolean optionsPreflightBypass) {
  ...
  **/
  ...
  public SelfHostedApplication1 sameSiteCookieAttribute(String sameSiteCookieAttribute) {
  ...
  **/
  ...
  public SelfHostedApplication1 serviceAuth401Redirect(Boolean serviceAuth401Redirect) {
  ...
  **/
  ...
  public SelfHostedApplication1 sessionDuration(String sessionDuration) {
  ...
  **/
  ...
  public SelfHostedApplication1 skipInterstitial(Boolean skipInterstitial) {
  ...
  **/
  ...
  public SelfHostedApplication1 type(String type) {
    this.type = type;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    SelfHostedApplication1 selfHostedApplication1 = (SelfHostedApplication1) o;
    return Objects.equals(this.aud, selfHostedApplication1.aud) &&
        Objects.equals(this.createdAt, selfHostedApplication1.createdAt) &&
        Objects.equals(this.id, selfHostedApplication1.id) &&
        Objects.equals(this.updatedAt, selfHostedApplication1.updatedAt) &&
        Objects.equals(this.allowedIdps, selfHostedApplication1.allowedIdps) &&
        Objects.equals(this.appLauncherVisible, selfHostedApplication1.appLauncherVisible) &&
        Objects.equals(this.autoRedirectToIdentity, selfHostedApplication1.autoRedirectToIdentity) &&
        Objects.equals(this.corsHeaders, selfHostedApplication1.corsHeaders) &&
        Objects.equals(this.customDenyMessage, selfHostedApplication1.customDenyMessage) &&
        Objects.equals(this.customDenyUrl, selfHostedApplication1.customDenyUrl) &&
        Objects.equals(this.domain, selfHostedApplication1.domain) &&
        Objects.equals(this.enableBindingCookie, selfHostedApplication1.enableBindingCookie) &&
        Objects.equals(this.httpOnlyCookieAttribute, selfHostedApplication1.httpOnlyCookieAttribute) &&
        Objects.equals(this.logoUrl, selfHostedApplication1.logoUrl) &&
        Objects.equals(this.name, selfHostedApplication1.name) &&
        Objects.equals(this.optionsPreflightBypass, selfHostedApplication1.optionsPreflightBypass) &&
        Objects.equals(this.sameSiteCookieAttribute, selfHostedApplication1.sameSiteCookieAttribute) &&
        Objects.equals(this.serviceAuth401Redirect, selfHostedApplication1.serviceAuth401Redirect) &&
        Objects.equals(this.sessionDuration, selfHostedApplication1.sessionDuration) &&
        Objects.equals(this.skipInterstitial, selfHostedApplication1.skipInterstitial) &&
        Objects.equals(this.type, selfHostedApplication1.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class SelfHostedApplication1 {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to SelfHostedApplication1
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SelfHostedApplication1.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SelfHostedApplication1 is not found in the empty JSON string", SelfHostedApplication1.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SelfHostedApplication1.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SelfHostedApplication1` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SelfHostedApplication1.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SelfHostedApplication1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SelfHostedApplication1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SelfHostedApplication1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SelfHostedApplication1.class));

       return (TypeAdapter<T>) new TypeAdapter<SelfHostedApplication1>() {
           @Override
           public void write(JsonWriter out, SelfHostedApplication1 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SelfHostedApplication1 read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of SelfHostedApplication1 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SelfHostedApplication1
  * @throws IOException if the JSON string is invalid with respect to SelfHostedApplication1
  */
  public static SelfHostedApplication1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SelfHostedApplication1.class);
  }

 /**
  * Convert an instance of SelfHostedApplication1 to an JSON string
  *
  * @return JSON string
  */
