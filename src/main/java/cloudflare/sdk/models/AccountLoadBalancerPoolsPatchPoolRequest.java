...
import cloudflare.sdk.models.LoadBalancingLoadShedding;
import cloudflare.sdk.models.LoadBalancingNotificationFilter;
import cloudflare.sdk.models.LoadBalancingOrigin;
import cloudflare.sdk.models.LoadBalancingOriginSteering;
...
public class AccountLoadBalancerPoolsPatchPoolRequest {
  /**
  ...
  public AccountLoadBalancerPoolsPatchPoolRequest() {
  }
  ...
  public AccountLoadBalancerPoolsPatchPoolRequest checkRegions(List<CheckRegionsEnum> checkRegions) {
    this.checkRegions = checkRegions;
    return this;
  }

  public AccountLoadBalancerPoolsPatchPoolRequest addCheckRegionsItem(CheckRegionsEnum checkRegionsItem) {
  ...
  **/
  ...
  public AccountLoadBalancerPoolsPatchPoolRequest description(String description) {
  ...
  **/
  ...
  public AccountLoadBalancerPoolsPatchPoolRequest enabled(Boolean enabled) {
  ...
  **/
  ...
  public AccountLoadBalancerPoolsPatchPoolRequest latitude(BigDecimal latitude) {
  ...
  **/
  ...
  public AccountLoadBalancerPoolsPatchPoolRequest loadShedding(LoadBalancingLoadShedding loadShedding) {
  ...
  **/
  ...
  public AccountLoadBalancerPoolsPatchPoolRequest longitude(BigDecimal longitude) {
  ...
  **/
  ...
  public AccountLoadBalancerPoolsPatchPoolRequest minimumOrigins(Integer minimumOrigins) {
  ...
  **/
  ...
  public AccountLoadBalancerPoolsPatchPoolRequest monitor(Object monitor) {
  ...
  **/
  ...
  public AccountLoadBalancerPoolsPatchPoolRequest name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public AccountLoadBalancerPoolsPatchPoolRequest notificationEmail(String notificationEmail) {
  ...
  **/
  ...
  public AccountLoadBalancerPoolsPatchPoolRequest notificationFilter(LoadBalancingNotificationFilter notificationFilter) {
  ...
  **/
  ...
  public AccountLoadBalancerPoolsPatchPoolRequest originSteering(LoadBalancingOriginSteering originSteering) {
  ...
  **/
  ...
  public AccountLoadBalancerPoolsPatchPoolRequest origins(List<LoadBalancingOrigin> origins) {
    this.origins = origins;
    return this;
  }

  public AccountLoadBalancerPoolsPatchPoolRequest addOriginsItem(LoadBalancingOrigin originsItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    AccountLoadBalancerPoolsPatchPoolRequest accountLoadBalancerPoolsPatchPoolRequest = (AccountLoadBalancerPoolsPatchPoolRequest) o;
    return Objects.equals(this.checkRegions, accountLoadBalancerPoolsPatchPoolRequest.checkRegions) &&
        Objects.equals(this.description, accountLoadBalancerPoolsPatchPoolRequest.description) &&
        Objects.equals(this.disabledAt, accountLoadBalancerPoolsPatchPoolRequest.disabledAt) &&
        Objects.equals(this.enabled, accountLoadBalancerPoolsPatchPoolRequest.enabled) &&
        Objects.equals(this.latitude, accountLoadBalancerPoolsPatchPoolRequest.latitude) &&
        Objects.equals(this.loadShedding, accountLoadBalancerPoolsPatchPoolRequest.loadShedding) &&
        Objects.equals(this.longitude, accountLoadBalancerPoolsPatchPoolRequest.longitude) &&
        Objects.equals(this.minimumOrigins, accountLoadBalancerPoolsPatchPoolRequest.minimumOrigins) &&
        Objects.equals(this.monitor, accountLoadBalancerPoolsPatchPoolRequest.monitor) &&
        Objects.equals(this.name, accountLoadBalancerPoolsPatchPoolRequest.name) &&
        Objects.equals(this.notificationEmail, accountLoadBalancerPoolsPatchPoolRequest.notificationEmail) &&
        Objects.equals(this.notificationFilter, accountLoadBalancerPoolsPatchPoolRequest.notificationFilter) &&
        Objects.equals(this.originSteering, accountLoadBalancerPoolsPatchPoolRequest.originSteering) &&
        Objects.equals(this.origins, accountLoadBalancerPoolsPatchPoolRequest.origins);
  }
  ...
  public String toString() {
    ...
    sb.append("class AccountLoadBalancerPoolsPatchPoolRequest {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to AccountLoadBalancerPoolsPatchPoolRequest
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AccountLoadBalancerPoolsPatchPoolRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AccountLoadBalancerPoolsPatchPoolRequest is not found in the empty JSON string", AccountLoadBalancerPoolsPatchPoolRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AccountLoadBalancerPoolsPatchPoolRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AccountLoadBalancerPoolsPatchPoolRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AccountLoadBalancerPoolsPatchPoolRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AccountLoadBalancerPoolsPatchPoolRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AccountLoadBalancerPoolsPatchPoolRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AccountLoadBalancerPoolsPatchPoolRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AccountLoadBalancerPoolsPatchPoolRequest>() {
           @Override
           public void write(JsonWriter out, AccountLoadBalancerPoolsPatchPoolRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AccountLoadBalancerPoolsPatchPoolRequest read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of AccountLoadBalancerPoolsPatchPoolRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AccountLoadBalancerPoolsPatchPoolRequest
  * @throws IOException if the JSON string is invalid with respect to AccountLoadBalancerPoolsPatchPoolRequest
  */
  public static AccountLoadBalancerPoolsPatchPoolRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AccountLoadBalancerPoolsPatchPoolRequest.class);
  }

 /**
  * Convert an instance of AccountLoadBalancerPoolsPatchPoolRequest to an JSON string
  *
  * @return JSON string
  */
