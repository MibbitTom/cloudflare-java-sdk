...
import cloudflare.sdk.models.BillSubsApiFrequency;
import cloudflare.sdk.models.BillSubsApiRatePlan;
import cloudflare.sdk.models.BillSubsApiState;
import cloudflare.sdk.models.BillSubsApiSubscriptionV2App;
import cloudflare.sdk.models.BillSubsApiZone;
...
public class BillSubsApiSubscriptionV2 {
  ...
  public BillSubsApiSubscriptionV2() {
  }
  ...
  public BillSubsApiSubscriptionV2 app(BillSubsApiSubscriptionV2App app) {
    this.app = app;
    return this;
  }
  ...
  **/
  ...
  public BillSubsApiSubscriptionV2 componentValues(List<BillSubsApiComponentValue> componentValues) {
    this.componentValues = componentValues;
    return this;
  }

  public BillSubsApiSubscriptionV2 addComponentValuesItem(BillSubsApiComponentValue componentValuesItem) {
  ...
  **/
  ...
  public BillSubsApiSubscriptionV2 frequency(BillSubsApiFrequency frequency) {
  ...
  **/
  ...
  public BillSubsApiSubscriptionV2 ratePlan(BillSubsApiRatePlan ratePlan) {
  ...
  **/
  ...
  public BillSubsApiSubscriptionV2 state(BillSubsApiState state) {
    this.state = state;
    return this;
  }
  ...
  **/
  ...
  public BillSubsApiSubscriptionV2 zone(BillSubsApiZone zone) {
    this.zone = zone;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    BillSubsApiSubscriptionV2 billSubsApiSubscriptionV2 = (BillSubsApiSubscriptionV2) o;
    return Objects.equals(this.app, billSubsApiSubscriptionV2.app) &&
        Objects.equals(this.componentValues, billSubsApiSubscriptionV2.componentValues) &&
        Objects.equals(this.currency, billSubsApiSubscriptionV2.currency) &&
        Objects.equals(this.currentPeriodEnd, billSubsApiSubscriptionV2.currentPeriodEnd) &&
        Objects.equals(this.currentPeriodStart, billSubsApiSubscriptionV2.currentPeriodStart) &&
        Objects.equals(this.frequency, billSubsApiSubscriptionV2.frequency) &&
        Objects.equals(this.id, billSubsApiSubscriptionV2.id) &&
        Objects.equals(this.price, billSubsApiSubscriptionV2.price) &&
        Objects.equals(this.ratePlan, billSubsApiSubscriptionV2.ratePlan) &&
        Objects.equals(this.state, billSubsApiSubscriptionV2.state) &&
        Objects.equals(this.zone, billSubsApiSubscriptionV2.zone);
  }
  ...
  public String toString() {
    ...
    sb.append("class BillSubsApiSubscriptionV2 {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to BillSubsApiSubscriptionV2
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BillSubsApiSubscriptionV2.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BillSubsApiSubscriptionV2 is not found in the empty JSON string", BillSubsApiSubscriptionV2.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BillSubsApiSubscriptionV2.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BillSubsApiSubscriptionV2` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BillSubsApiSubscriptionV2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BillSubsApiSubscriptionV2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BillSubsApiSubscriptionV2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BillSubsApiSubscriptionV2.class));

       return (TypeAdapter<T>) new TypeAdapter<BillSubsApiSubscriptionV2>() {
           @Override
           public void write(JsonWriter out, BillSubsApiSubscriptionV2 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BillSubsApiSubscriptionV2 read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of BillSubsApiSubscriptionV2 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of BillSubsApiSubscriptionV2
  * @throws IOException if the JSON string is invalid with respect to BillSubsApiSubscriptionV2
  */
  public static BillSubsApiSubscriptionV2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BillSubsApiSubscriptionV2.class);
  }

 /**
  * Convert an instance of BillSubsApiSubscriptionV2 to an JSON string
  *
  * @return JSON string
  */
