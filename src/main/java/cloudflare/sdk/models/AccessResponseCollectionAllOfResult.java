...
import cloudflare.sdk.models.AccessAzureAD;
import cloudflare.sdk.models.AccessCentrify;
import cloudflare.sdk.models.AccessFacebook;
import cloudflare.sdk.models.AccessGenericOauthConfig;
import cloudflare.sdk.models.AccessGithub;
import cloudflare.sdk.models.AccessGoogle;
import cloudflare.sdk.models.AccessGoogleApps;
import cloudflare.sdk.models.AccessIdentityProviderScimConfig;
import cloudflare.sdk.models.AccessLinkedin;
import cloudflare.sdk.models.AccessOidc;
import cloudflare.sdk.models.AccessOkta;
import cloudflare.sdk.models.AccessOnelogin;
import cloudflare.sdk.models.AccessPingone;
import cloudflare.sdk.models.AccessSaml;
import cloudflare.sdk.models.AccessYandex;
...
public class AccessResponseCollectionAllOfResult extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(AccessResponseCollectionAllOfResult.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!AccessResponseCollectionAllOfResult.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'AccessResponseCollectionAllOfResult' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<AccessResponseCollectionAllOfResult>() {
                @Override
                public void write(JsonWriter out, AccessResponseCollectionAllOfResult value) throws IOException {
                    ...
                    throw new IOException("Failed to serialize as the type doesn't match anyOf schemas: AccessAzureAD, AccessCentrify, AccessFacebook, AccessGithub, AccessGoogle, AccessGoogleApps, AccessLinkedin, AccessOidc, AccessOkta, AccessOnelogin, AccessPingone, AccessSaml, AccessYandex");
                }

                @Override
                public AccessResponseCollectionAllOfResult read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        AccessResponseCollectionAllOfResult ret = new AccessResponseCollectionAllOfResult();
                    ...
                    throw new IOException(String.format("Failed deserialization for AccessResponseCollectionAllOfResult: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public AccessResponseCollectionAllOfResult() {
        super("anyOf", Boolean.FALSE);
    }

    public AccessResponseCollectionAllOfResult(AccessAzureAD o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public AccessResponseCollectionAllOfResult(AccessCentrify o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public AccessResponseCollectionAllOfResult(AccessFacebook o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public AccessResponseCollectionAllOfResult(AccessGithub o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public AccessResponseCollectionAllOfResult(AccessGoogle o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public AccessResponseCollectionAllOfResult(AccessGoogleApps o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public AccessResponseCollectionAllOfResult(AccessLinkedin o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public AccessResponseCollectionAllOfResult(AccessOidc o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public AccessResponseCollectionAllOfResult(AccessOkta o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public AccessResponseCollectionAllOfResult(AccessOnelogin o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public AccessResponseCollectionAllOfResult(AccessPingone o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public AccessResponseCollectionAllOfResult(AccessSaml o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public AccessResponseCollectionAllOfResult(AccessYandex o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return AccessResponseCollectionAllOfResult.schemas;
    }

    /**
     * Set the instance that matches the anyOf child schema, check
     * the instance parameter is valid against the anyOf child schemas:
     * AccessAzureAD, AccessCentrify, AccessFacebook, AccessGithub, AccessGoogle, AccessGoogleApps, AccessLinkedin, AccessOidc, AccessOkta, AccessOnelogin, AccessPingone, AccessSaml, AccessYandex
     *
    ...
    public void setActualInstance(Object instance) {
        ...
        throw new RuntimeException("Invalid instance type. Must be AccessAzureAD, AccessCentrify, AccessFacebook, AccessGithub, AccessGoogle, AccessGoogleApps, AccessLinkedin, AccessOidc, AccessOkta, AccessOnelogin, AccessPingone, AccessSaml, AccessYandex");
    }
     ...
     * AccessAzureAD, AccessCentrify, AccessFacebook, AccessGithub, AccessGoogle, AccessGoogleApps, AccessLinkedin, AccessOidc, AccessOkta, AccessOnelogin, AccessPingone, AccessSaml, AccessYandex
     *
     * @return The actual instance (AccessAzureAD, AccessCentrify, AccessFacebook, AccessGithub, AccessGoogle, AccessGoogleApps, AccessLinkedin, AccessOidc, AccessOkta, AccessOnelogin, AccessPingone, AccessSaml, AccessYandex)
     */
    @SuppressWarnings("unchecked")
    @Override
     ...
     * @throws IOException if the JSON Element is invalid with respect to AccessResponseCollectionAllOfResult
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format("The JSON string is invalid for AccessResponseCollectionAllOfResult with anyOf schemas: AccessAzureAD, AccessCentrify, AccessFacebook, AccessGithub, AccessGoogle, AccessGoogleApps, AccessLinkedin, AccessOidc, AccessOkta, AccessOnelogin, AccessPingone, AccessSaml, AccessYandex. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of AccessResponseCollectionAllOfResult given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of AccessResponseCollectionAllOfResult
     * @throws IOException if the JSON string is invalid with respect to AccessResponseCollectionAllOfResult
     */
    public static AccessResponseCollectionAllOfResult fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, AccessResponseCollectionAllOfResult.class);
    }

    /**
     * Convert an instance of AccessResponseCollectionAllOfResult to an JSON string
     *
     * @return JSON string
     */
