...
public class MagicAcl {
  ...
  public MagicAcl description(String description) {
  ...
  **/
  ...
  public MagicAcl forwardLocally(Boolean forwardLocally) {
  ...
  **/
  ...
  public MagicAcl lan1(MagicLanAclConfiguration lan1) {
    this.lan1 = lan1;
    return this;
  }
  ...
  **/
  ...
  public MagicAcl lan2(MagicLanAclConfiguration lan2) {
    this.lan2 = lan2;
    return this;
  }
  ...
  **/
  ...
  public MagicAcl name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public MagicAcl protocols(List<ProtocolsEnum> protocols) {
    this.protocols = protocols;
    return this;
  }

  public MagicAcl addProtocolsItem(ProtocolsEnum protocolsItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    MagicAcl magicAcl = (MagicAcl) o;
    return Objects.equals(this.description, magicAcl.description) &&
        Objects.equals(this.forwardLocally, magicAcl.forwardLocally) &&
        Objects.equals(this.id, magicAcl.id) &&
        Objects.equals(this.lan1, magicAcl.lan1) &&
        Objects.equals(this.lan2, magicAcl.lan2) &&
        Objects.equals(this.name, magicAcl.name) &&
        Objects.equals(this.protocols, magicAcl.protocols);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, forwardLocally, id, lan1, lan2, name, protocols);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class MagicAcl {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to MagicAcl
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MagicAcl.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MagicAcl is not found in the empty JSON string", MagicAcl.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MagicAcl.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MagicAcl` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MagicAcl.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MagicAcl' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MagicAcl> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MagicAcl.class));

       return (TypeAdapter<T>) new TypeAdapter<MagicAcl>() {
           @Override
           public void write(JsonWriter out, MagicAcl value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MagicAcl read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of MagicAcl given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of MagicAcl
  * @throws IOException if the JSON string is invalid with respect to MagicAcl
  */
  public static MagicAcl fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MagicAcl.class);
  }

 /**
  * Convert an instance of MagicAcl to an JSON string
  *
  * @return JSON string
  */
