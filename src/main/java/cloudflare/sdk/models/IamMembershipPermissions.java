...
import cloudflare.sdk.models.IamGrants;
...
public class IamMembershipPermissions {
  ...
  public IamMembershipPermissions() {
  }

  public IamMembershipPermissions analytics(IamGrants analytics) {
  ...
  **/
  ...
  public IamMembershipPermissions billing(IamGrants billing) {
  ...
  **/
  ...
  public IamMembershipPermissions cachePurge(IamGrants cachePurge) {
  ...
  **/
  ...
  public IamMembershipPermissions dns(IamGrants dns) {
    this.dns = dns;
    return this;
  }
  ...
  **/
  ...
  public IamMembershipPermissions dnsRecords(IamGrants dnsRecords) {
  ...
  **/
  ...
  public IamMembershipPermissions lb(IamGrants lb) {
    this.lb = lb;
    return this;
  }
  ...
  **/
  ...
  public IamMembershipPermissions logs(IamGrants logs) {
    this.logs = logs;
    return this;
  }
  ...
  **/
  ...
  public IamMembershipPermissions organization(IamGrants organization) {
  ...
  **/
  ...
  public IamMembershipPermissions ssl(IamGrants ssl) {
    this.ssl = ssl;
    return this;
  }
  ...
  **/
  ...
  public IamMembershipPermissions waf(IamGrants waf) {
    this.waf = waf;
    return this;
  }
  ...
  **/
  ...
  public IamMembershipPermissions zoneSettings(IamGrants zoneSettings) {
  ...
  **/
  ...
  public IamMembershipPermissions zones(IamGrants zones) {
    this.zones = zones;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    IamMembershipPermissions iamMembershipPermissions = (IamMembershipPermissions) o;
    return Objects.equals(this.analytics, iamMembershipPermissions.analytics) &&
        Objects.equals(this.billing, iamMembershipPermissions.billing) &&
        Objects.equals(this.cachePurge, iamMembershipPermissions.cachePurge) &&
        Objects.equals(this.dns, iamMembershipPermissions.dns) &&
        Objects.equals(this.dnsRecords, iamMembershipPermissions.dnsRecords) &&
        Objects.equals(this.lb, iamMembershipPermissions.lb) &&
        Objects.equals(this.logs, iamMembershipPermissions.logs) &&
        Objects.equals(this.organization, iamMembershipPermissions.organization) &&
        Objects.equals(this.ssl, iamMembershipPermissions.ssl) &&
        Objects.equals(this.waf, iamMembershipPermissions.waf) &&
        Objects.equals(this.zoneSettings, iamMembershipPermissions.zoneSettings) &&
        Objects.equals(this.zones, iamMembershipPermissions.zones);
  }
  ...
  public String toString() {
    ...
    sb.append("class IamMembershipPermissions {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to IamMembershipPermissions
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IamMembershipPermissions.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IamMembershipPermissions is not found in the empty JSON string", IamMembershipPermissions.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IamMembershipPermissions.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `IamMembershipPermissions` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IamMembershipPermissions.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IamMembershipPermissions' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IamMembershipPermissions> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IamMembershipPermissions.class));

       return (TypeAdapter<T>) new TypeAdapter<IamMembershipPermissions>() {
           @Override
           public void write(JsonWriter out, IamMembershipPermissions value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public IamMembershipPermissions read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of IamMembershipPermissions given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of IamMembershipPermissions
  * @throws IOException if the JSON string is invalid with respect to IamMembershipPermissions
  */
  public static IamMembershipPermissions fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IamMembershipPermissions.class);
  }

 /**
  * Convert an instance of IamMembershipPermissions to an JSON string
  *
  * @return JSON string
  */
