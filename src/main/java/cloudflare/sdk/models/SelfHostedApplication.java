...
public class SelfHostedApplication {
  ...
  **/
  ...
  public SelfHostedApplication allowAuthenticateViaWarp(Boolean allowAuthenticateViaWarp) {
  ...
  **/
  ...
  public SelfHostedApplication allowedIdps(List<String> allowedIdps) {
    this.allowedIdps = allowedIdps;
    return this;
  }

  public SelfHostedApplication addAllowedIdpsItem(String allowedIdpsItem) {
  ...
  **/
  ...
  public SelfHostedApplication appLauncherVisible(Boolean appLauncherVisible) {
  ...
  **/
  ...
  public SelfHostedApplication autoRedirectToIdentity(Boolean autoRedirectToIdentity) {
  ...
  **/
  ...
  public SelfHostedApplication corsHeaders(AccessCorsHeaders corsHeaders) {
  ...
  **/
  ...
  public SelfHostedApplication customDenyMessage(String customDenyMessage) {
  ...
  **/
  ...
  public SelfHostedApplication customDenyUrl(String customDenyUrl) {
  ...
  **/
  ...
  public SelfHostedApplication customNonIdentityDenyUrl(String customNonIdentityDenyUrl) {
  ...
  **/
  ...
  public SelfHostedApplication customPages(List<String> customPages) {
    this.customPages = customPages;
    return this;
  }

  public SelfHostedApplication addCustomPagesItem(String customPagesItem) {
  ...
  **/
  ...
  public SelfHostedApplication domain(String domain) {
    this.domain = domain;
    return this;
  }
  ...
  **/
  ...
  public SelfHostedApplication enableBindingCookie(Boolean enableBindingCookie) {
  ...
  **/
  ...
  public SelfHostedApplication httpOnlyCookieAttribute(Boolean httpOnlyCookieAttribute) {
  ...
  **/
  ...
  public SelfHostedApplication logoUrl(String logoUrl) {
  ...
  **/
  ...
  public SelfHostedApplication name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public SelfHostedApplication optionsPreflightBypass(Boolean optionsPreflightBypass) {
  ...
  **/
  ...
  public SelfHostedApplication pathCookieAttribute(Boolean pathCookieAttribute) {
  ...
  **/
  ...
  public SelfHostedApplication sameSiteCookieAttribute(String sameSiteCookieAttribute) {
  ...
  **/
  ...
  public SelfHostedApplication selfHostedDomains(List<String> selfHostedDomains) {
    this.selfHostedDomains = selfHostedDomains;
    return this;
  }

  public SelfHostedApplication addSelfHostedDomainsItem(String selfHostedDomainsItem) {
  ...
  **/
  ...
  public SelfHostedApplication serviceAuth401Redirect(Boolean serviceAuth401Redirect) {
  ...
  **/
  ...
  public SelfHostedApplication sessionDuration(String sessionDuration) {
  ...
  **/
  ...
  public SelfHostedApplication skipInterstitial(Boolean skipInterstitial) {
  ...
  **/
  ...
  public SelfHostedApplication tags(List<String> tags) {
    this.tags = tags;
    return this;
  }

  public SelfHostedApplication addTagsItem(String tagsItem) {
    if (this.tags == null) {
  ...
  **/
  ...
  public SelfHostedApplication type(String type) {
    this.type = type;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    SelfHostedApplication selfHostedApplication = (SelfHostedApplication) o;
    return Objects.equals(this.aud, selfHostedApplication.aud) &&
        Objects.equals(this.createdAt, selfHostedApplication.createdAt) &&
        Objects.equals(this.id, selfHostedApplication.id) &&
        Objects.equals(this.updatedAt, selfHostedApplication.updatedAt) &&
        Objects.equals(this.allowAuthenticateViaWarp, selfHostedApplication.allowAuthenticateViaWarp) &&
        Objects.equals(this.allowedIdps, selfHostedApplication.allowedIdps) &&
        Objects.equals(this.appLauncherVisible, selfHostedApplication.appLauncherVisible) &&
        Objects.equals(this.autoRedirectToIdentity, selfHostedApplication.autoRedirectToIdentity) &&
        Objects.equals(this.corsHeaders, selfHostedApplication.corsHeaders) &&
        Objects.equals(this.customDenyMessage, selfHostedApplication.customDenyMessage) &&
        Objects.equals(this.customDenyUrl, selfHostedApplication.customDenyUrl) &&
        Objects.equals(this.customNonIdentityDenyUrl, selfHostedApplication.customNonIdentityDenyUrl) &&
        Objects.equals(this.customPages, selfHostedApplication.customPages) &&
        Objects.equals(this.domain, selfHostedApplication.domain) &&
        Objects.equals(this.enableBindingCookie, selfHostedApplication.enableBindingCookie) &&
        Objects.equals(this.httpOnlyCookieAttribute, selfHostedApplication.httpOnlyCookieAttribute) &&
        Objects.equals(this.logoUrl, selfHostedApplication.logoUrl) &&
        Objects.equals(this.name, selfHostedApplication.name) &&
        Objects.equals(this.optionsPreflightBypass, selfHostedApplication.optionsPreflightBypass) &&
        Objects.equals(this.pathCookieAttribute, selfHostedApplication.pathCookieAttribute) &&
        Objects.equals(this.sameSiteCookieAttribute, selfHostedApplication.sameSiteCookieAttribute) &&
        Objects.equals(this.selfHostedDomains, selfHostedApplication.selfHostedDomains) &&
        Objects.equals(this.serviceAuth401Redirect, selfHostedApplication.serviceAuth401Redirect) &&
        Objects.equals(this.sessionDuration, selfHostedApplication.sessionDuration) &&
        Objects.equals(this.skipInterstitial, selfHostedApplication.skipInterstitial) &&
        Objects.equals(this.tags, selfHostedApplication.tags) &&
        Objects.equals(this.type, selfHostedApplication.type);
  }

  @Override
  public int hashCode() {
    return Objects.hash(aud, createdAt, id, updatedAt, allowAuthenticateViaWarp, allowedIdps, appLauncherVisible, autoRedirectToIdentity, corsHeaders, customDenyMessage, customDenyUrl, customNonIdentityDenyUrl, customPages, domain, enableBindingCookie, httpOnlyCookieAttribute, logoUrl, name, optionsPreflightBypass, pathCookieAttribute, sameSiteCookieAttribute, selfHostedDomains, serviceAuth401Redirect, sessionDuration, skipInterstitial, tags, type);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SelfHostedApplication {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to SelfHostedApplication
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SelfHostedApplication.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SelfHostedApplication is not found in the empty JSON string", SelfHostedApplication.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SelfHostedApplication.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SelfHostedApplication` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SelfHostedApplication.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SelfHostedApplication.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SelfHostedApplication' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SelfHostedApplication> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SelfHostedApplication.class));

       return (TypeAdapter<T>) new TypeAdapter<SelfHostedApplication>() {
           @Override
           public void write(JsonWriter out, SelfHostedApplication value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SelfHostedApplication read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of SelfHostedApplication given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SelfHostedApplication
  * @throws IOException if the JSON string is invalid with respect to SelfHostedApplication
  */
  public static SelfHostedApplication fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SelfHostedApplication.class);
  }

 /**
  * Convert an instance of SelfHostedApplication to an JSON string
  *
  * @return JSON string
  */
