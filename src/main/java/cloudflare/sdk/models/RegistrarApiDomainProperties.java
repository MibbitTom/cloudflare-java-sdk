...
import cloudflare.sdk.models.RegistrarApiRegistrantContact;
import cloudflare.sdk.models.RegistrarApiTransferIn;
...
public class RegistrarApiDomainProperties {
  ...
  public RegistrarApiDomainProperties() {
  }
  ...
  public RegistrarApiDomainProperties available(Boolean available) {
  ...
  **/
  ...
  public RegistrarApiDomainProperties canRegister(Boolean canRegister) {
  ...
  **/
  ...
  public RegistrarApiDomainProperties createdAt(OffsetDateTime createdAt) {
  ...
  **/
  ...
  public RegistrarApiDomainProperties currentRegistrar(String currentRegistrar) {
  ...
  **/
  ...
  public RegistrarApiDomainProperties expiresAt(OffsetDateTime expiresAt) {
  ...
  **/
  ...
  public RegistrarApiDomainProperties locked(Boolean locked) {
    this.locked = locked;
    return this;
  }
  ...
  **/
  ...
  public RegistrarApiDomainProperties registrantContact(RegistrarApiRegistrantContact registrantContact) {
  ...
  **/
  ...
  public RegistrarApiDomainProperties registryStatuses(String registryStatuses) {
  ...
  **/
  ...
  public RegistrarApiDomainProperties supportedTld(Boolean supportedTld) {
  ...
  **/
  ...
  public RegistrarApiDomainProperties transferIn(RegistrarApiTransferIn transferIn) {
  ...
  **/
  ...
  public RegistrarApiDomainProperties updatedAt(OffsetDateTime updatedAt) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    RegistrarApiDomainProperties registrarApiDomainProperties = (RegistrarApiDomainProperties) o;
    return Objects.equals(this.available, registrarApiDomainProperties.available) &&
        Objects.equals(this.canRegister, registrarApiDomainProperties.canRegister) &&
        Objects.equals(this.createdAt, registrarApiDomainProperties.createdAt) &&
        Objects.equals(this.currentRegistrar, registrarApiDomainProperties.currentRegistrar) &&
        Objects.equals(this.expiresAt, registrarApiDomainProperties.expiresAt) &&
        Objects.equals(this.id, registrarApiDomainProperties.id) &&
        Objects.equals(this.locked, registrarApiDomainProperties.locked) &&
        Objects.equals(this.registrantContact, registrarApiDomainProperties.registrantContact) &&
        Objects.equals(this.registryStatuses, registrarApiDomainProperties.registryStatuses) &&
        Objects.equals(this.supportedTld, registrarApiDomainProperties.supportedTld) &&
        Objects.equals(this.transferIn, registrarApiDomainProperties.transferIn) &&
        Objects.equals(this.updatedAt, registrarApiDomainProperties.updatedAt);
  }
  ...
  public String toString() {
    ...
    sb.append("class RegistrarApiDomainProperties {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to RegistrarApiDomainProperties
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RegistrarApiDomainProperties.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RegistrarApiDomainProperties is not found in the empty JSON string", RegistrarApiDomainProperties.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RegistrarApiDomainProperties.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RegistrarApiDomainProperties` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RegistrarApiDomainProperties.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RegistrarApiDomainProperties' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RegistrarApiDomainProperties> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RegistrarApiDomainProperties.class));

       return (TypeAdapter<T>) new TypeAdapter<RegistrarApiDomainProperties>() {
           @Override
           public void write(JsonWriter out, RegistrarApiDomainProperties value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RegistrarApiDomainProperties read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of RegistrarApiDomainProperties given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of RegistrarApiDomainProperties
  * @throws IOException if the JSON string is invalid with respect to RegistrarApiDomainProperties
  */
  public static RegistrarApiDomainProperties fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RegistrarApiDomainProperties.class);
  }

 /**
  * Convert an instance of RegistrarApiDomainProperties to an JSON string
  *
  * @return JSON string
  */
