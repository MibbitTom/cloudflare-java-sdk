...
import cloudflare.sdk.models.WorkersAiPostRunCfDeepseekAiDeepseekMath7bInstruct200ResponseResultOneOf;
...
public class TextGeneration extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(TextGeneration.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!TextGeneration.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'TextGeneration' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<TextGeneration>() {
                @Override
                public void write(JsonWriter out, TextGeneration value) throws IOException {
                ...
                @Override
                public TextGeneration read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        TextGeneration ret = new TextGeneration();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for TextGeneration: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public TextGeneration(File o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public TextGeneration(WorkersAiPostRunCfDeepseekAiDeepseekMath7bInstruct200ResponseResultOneOf o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to TextGeneration
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format("The JSON string is invalid for TextGeneration with oneOf schemas: File, WorkersAiPostRunCfDeepseekAiDeepseekMath7bInstruct200ResponseResultOneOf. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }

    /**
     * Create an instance of TextGeneration given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of TextGeneration
     * @throws IOException if the JSON string is invalid with respect to TextGeneration
     */
    public static TextGeneration fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, TextGeneration.class);
    }

    /**
     * Convert an instance of TextGeneration to an JSON string
     *
     * @return JSON string
     */
