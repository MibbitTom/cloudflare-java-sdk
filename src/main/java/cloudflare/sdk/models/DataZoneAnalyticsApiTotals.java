...
import cloudflare.sdk.models.DataZoneAnalyticsApiBandwidth;
import cloudflare.sdk.models.DataZoneAnalyticsApiPageviews;
import cloudflare.sdk.models.DataZoneAnalyticsApiRequests;
import cloudflare.sdk.models.DataZoneAnalyticsApiSince;
import cloudflare.sdk.models.DataZoneAnalyticsApiThreats;
import cloudflare.sdk.models.DataZoneAnalyticsApiUniques;
...
public class DataZoneAnalyticsApiTotals {
  ...
  public DataZoneAnalyticsApiTotals() {
  }

  public DataZoneAnalyticsApiTotals bandwidth(DataZoneAnalyticsApiBandwidth bandwidth) {
  ...
  **/
  ...
  public DataZoneAnalyticsApiTotals pageviews(DataZoneAnalyticsApiPageviews pageviews) {
  ...
  **/
  ...
  public DataZoneAnalyticsApiTotals requests(DataZoneAnalyticsApiRequests requests) {
  ...
  **/
  ...
  public DataZoneAnalyticsApiTotals since(DataZoneAnalyticsApiSince since) {
    this.since = since;
    return this;
  }
  ...
  **/
  ...
  public DataZoneAnalyticsApiTotals threats(DataZoneAnalyticsApiThreats threats) {
  ...
  **/
  ...
  public DataZoneAnalyticsApiTotals uniques(DataZoneAnalyticsApiUniques uniques) {
  ...
  **/
  ...
  public DataZoneAnalyticsApiTotals until(DataZoneAnalyticsApiUntil until) {
    this.until = until;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DataZoneAnalyticsApiTotals dataZoneAnalyticsApiTotals = (DataZoneAnalyticsApiTotals) o;
    return Objects.equals(this.bandwidth, dataZoneAnalyticsApiTotals.bandwidth) &&
        Objects.equals(this.pageviews, dataZoneAnalyticsApiTotals.pageviews) &&
        Objects.equals(this.requests, dataZoneAnalyticsApiTotals.requests) &&
        Objects.equals(this.since, dataZoneAnalyticsApiTotals.since) &&
        Objects.equals(this.threats, dataZoneAnalyticsApiTotals.threats) &&
        Objects.equals(this.uniques, dataZoneAnalyticsApiTotals.uniques) &&
        Objects.equals(this.until, dataZoneAnalyticsApiTotals.until);
  }
  ...
  public String toString() {
    ...
    sb.append("class DataZoneAnalyticsApiTotals {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to DataZoneAnalyticsApiTotals
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DataZoneAnalyticsApiTotals.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DataZoneAnalyticsApiTotals is not found in the empty JSON string", DataZoneAnalyticsApiTotals.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DataZoneAnalyticsApiTotals.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DataZoneAnalyticsApiTotals` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DataZoneAnalyticsApiTotals.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DataZoneAnalyticsApiTotals' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DataZoneAnalyticsApiTotals> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DataZoneAnalyticsApiTotals.class));

       return (TypeAdapter<T>) new TypeAdapter<DataZoneAnalyticsApiTotals>() {
           @Override
           public void write(JsonWriter out, DataZoneAnalyticsApiTotals value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DataZoneAnalyticsApiTotals read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of DataZoneAnalyticsApiTotals given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DataZoneAnalyticsApiTotals
  * @throws IOException if the JSON string is invalid with respect to DataZoneAnalyticsApiTotals
  */
  public static DataZoneAnalyticsApiTotals fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DataZoneAnalyticsApiTotals.class);
  }

 /**
  * Convert an instance of DataZoneAnalyticsApiTotals to an JSON string
  *
  * @return JSON string
  */
