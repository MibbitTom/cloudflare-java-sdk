...
public class BrowserVNCApplication1 {
  ...
  **/
  ...
  public BrowserVNCApplication1 allowedIdps(List<String> allowedIdps) {
    this.allowedIdps = allowedIdps;
    return this;
  }

  public BrowserVNCApplication1 addAllowedIdpsItem(String allowedIdpsItem) {
  ...
  **/
  ...
  public BrowserVNCApplication1 appLauncherVisible(Boolean appLauncherVisible) {
  ...
  **/
  ...
  public BrowserVNCApplication1 autoRedirectToIdentity(Boolean autoRedirectToIdentity) {
  ...
  **/
  ...
  public BrowserVNCApplication1 corsHeaders(AccessSchemasCorsHeaders corsHeaders) {
  ...
  **/
  ...
  public BrowserVNCApplication1 customDenyMessage(String customDenyMessage) {
  ...
  **/
  ...
  public BrowserVNCApplication1 customDenyUrl(String customDenyUrl) {
  ...
  **/
  ...
  public BrowserVNCApplication1 domain(String domain) {
    this.domain = domain;
    return this;
  }
  ...
  **/
  ...
  public BrowserVNCApplication1 enableBindingCookie(Boolean enableBindingCookie) {
  ...
  **/
  ...
  public BrowserVNCApplication1 httpOnlyCookieAttribute(Boolean httpOnlyCookieAttribute) {
  ...
  **/
  ...
  public BrowserVNCApplication1 logoUrl(String logoUrl) {
  ...
  **/
  ...
  public BrowserVNCApplication1 name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public BrowserVNCApplication1 optionsPreflightBypass(Boolean optionsPreflightBypass) {
  ...
  **/
  ...
  public BrowserVNCApplication1 sameSiteCookieAttribute(String sameSiteCookieAttribute) {
  ...
  **/
  ...
  public BrowserVNCApplication1 serviceAuth401Redirect(Boolean serviceAuth401Redirect) {
  ...
  **/
  ...
  public BrowserVNCApplication1 sessionDuration(String sessionDuration) {
  ...
  **/
  ...
  public BrowserVNCApplication1 skipInterstitial(Boolean skipInterstitial) {
  ...
  **/
  ...
  public BrowserVNCApplication1 type(String type) {
    this.type = type;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    BrowserVNCApplication1 browserVNCApplication1 = (BrowserVNCApplication1) o;
    return Objects.equals(this.aud, browserVNCApplication1.aud) &&
        Objects.equals(this.createdAt, browserVNCApplication1.createdAt) &&
        Objects.equals(this.id, browserVNCApplication1.id) &&
        Objects.equals(this.updatedAt, browserVNCApplication1.updatedAt) &&
        Objects.equals(this.allowedIdps, browserVNCApplication1.allowedIdps) &&
        Objects.equals(this.appLauncherVisible, browserVNCApplication1.appLauncherVisible) &&
        Objects.equals(this.autoRedirectToIdentity, browserVNCApplication1.autoRedirectToIdentity) &&
        Objects.equals(this.corsHeaders, browserVNCApplication1.corsHeaders) &&
        Objects.equals(this.customDenyMessage, browserVNCApplication1.customDenyMessage) &&
        Objects.equals(this.customDenyUrl, browserVNCApplication1.customDenyUrl) &&
        Objects.equals(this.domain, browserVNCApplication1.domain) &&
        Objects.equals(this.enableBindingCookie, browserVNCApplication1.enableBindingCookie) &&
        Objects.equals(this.httpOnlyCookieAttribute, browserVNCApplication1.httpOnlyCookieAttribute) &&
        Objects.equals(this.logoUrl, browserVNCApplication1.logoUrl) &&
        Objects.equals(this.name, browserVNCApplication1.name) &&
        Objects.equals(this.optionsPreflightBypass, browserVNCApplication1.optionsPreflightBypass) &&
        Objects.equals(this.sameSiteCookieAttribute, browserVNCApplication1.sameSiteCookieAttribute) &&
        Objects.equals(this.serviceAuth401Redirect, browserVNCApplication1.serviceAuth401Redirect) &&
        Objects.equals(this.sessionDuration, browserVNCApplication1.sessionDuration) &&
        Objects.equals(this.skipInterstitial, browserVNCApplication1.skipInterstitial) &&
        Objects.equals(this.type, browserVNCApplication1.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class BrowserVNCApplication1 {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to BrowserVNCApplication1
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BrowserVNCApplication1.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BrowserVNCApplication1 is not found in the empty JSON string", BrowserVNCApplication1.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BrowserVNCApplication1.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BrowserVNCApplication1` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : BrowserVNCApplication1.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BrowserVNCApplication1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BrowserVNCApplication1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BrowserVNCApplication1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BrowserVNCApplication1.class));

       return (TypeAdapter<T>) new TypeAdapter<BrowserVNCApplication1>() {
           @Override
           public void write(JsonWriter out, BrowserVNCApplication1 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BrowserVNCApplication1 read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of BrowserVNCApplication1 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of BrowserVNCApplication1
  * @throws IOException if the JSON string is invalid with respect to BrowserVNCApplication1
  */
  public static BrowserVNCApplication1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BrowserVNCApplication1.class);
  }

 /**
  * Convert an instance of BrowserVNCApplication1 to an JSON string
  *
  * @return JSON string
  */
