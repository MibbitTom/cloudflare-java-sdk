...
import cloudflare.sdk.models.DnsFirewallAttackMitigation;
import cloudflare.sdk.models.DnsFirewallDnsFirewallIpsInner;
import cloudflare.sdk.models.DnsFirewallUpstreamIpsInner;
...
public class DnsFirewallDnsFirewall {
  ...
  public DnsFirewallDnsFirewall attackMitigation(DnsFirewallAttackMitigation attackMitigation) {
  ...
  **/
  ...
  public DnsFirewallDnsFirewall deprecateAnyRequests(Boolean deprecateAnyRequests) {
  ...
  **/
  ...
  public DnsFirewallDnsFirewall dnsFirewallIps(List<DnsFirewallDnsFirewallIpsInner> dnsFirewallIps) {
    this.dnsFirewallIps = dnsFirewallIps;
    return this;
  }

  public DnsFirewallDnsFirewall addDnsFirewallIpsItem(DnsFirewallDnsFirewallIpsInner dnsFirewallIpsItem) {
  ...
  **/
  ...
  public DnsFirewallDnsFirewall ecsFallback(Boolean ecsFallback) {
  ...
  **/
  ...
  public DnsFirewallDnsFirewall maximumCacheTtl(BigDecimal maximumCacheTtl) {
  ...
  **/
  ...
  public DnsFirewallDnsFirewall minimumCacheTtl(BigDecimal minimumCacheTtl) {
  ...
  **/
  ...
  public DnsFirewallDnsFirewall name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public DnsFirewallDnsFirewall negativeCacheTtl(BigDecimal negativeCacheTtl) {
  ...
  **/
  ...
  public DnsFirewallDnsFirewall ratelimit(BigDecimal ratelimit) {
  ...
  **/
  ...
  public DnsFirewallDnsFirewall retries(BigDecimal retries) {
  ...
  **/
  ...
  public DnsFirewallDnsFirewall upstreamIps(List<DnsFirewallUpstreamIpsInner> upstreamIps) {
    this.upstreamIps = upstreamIps;
    return this;
  }

  public DnsFirewallDnsFirewall addUpstreamIpsItem(DnsFirewallUpstreamIpsInner upstreamIpsItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DnsFirewallDnsFirewall dnsFirewallDnsFirewall = (DnsFirewallDnsFirewall) o;
    return Objects.equals(this.attackMitigation, dnsFirewallDnsFirewall.attackMitigation) &&
        Objects.equals(this.deprecateAnyRequests, dnsFirewallDnsFirewall.deprecateAnyRequests) &&
        Objects.equals(this.dnsFirewallIps, dnsFirewallDnsFirewall.dnsFirewallIps) &&
        Objects.equals(this.ecsFallback, dnsFirewallDnsFirewall.ecsFallback) &&
        Objects.equals(this.id, dnsFirewallDnsFirewall.id) &&
        Objects.equals(this.maximumCacheTtl, dnsFirewallDnsFirewall.maximumCacheTtl) &&
        Objects.equals(this.minimumCacheTtl, dnsFirewallDnsFirewall.minimumCacheTtl) &&
        Objects.equals(this.modifiedOn, dnsFirewallDnsFirewall.modifiedOn) &&
        Objects.equals(this.name, dnsFirewallDnsFirewall.name) &&
        Objects.equals(this.negativeCacheTtl, dnsFirewallDnsFirewall.negativeCacheTtl) &&
        Objects.equals(this.ratelimit, dnsFirewallDnsFirewall.ratelimit) &&
        Objects.equals(this.retries, dnsFirewallDnsFirewall.retries) &&
        Objects.equals(this.upstreamIps, dnsFirewallDnsFirewall.upstreamIps);
  }
  ...
  public String toString() {
    ...
    sb.append("class DnsFirewallDnsFirewall {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to DnsFirewallDnsFirewall
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DnsFirewallDnsFirewall.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DnsFirewallDnsFirewall is not found in the empty JSON string", DnsFirewallDnsFirewall.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DnsFirewallDnsFirewall.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DnsFirewallDnsFirewall` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DnsFirewallDnsFirewall.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DnsFirewallDnsFirewall.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DnsFirewallDnsFirewall' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DnsFirewallDnsFirewall> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DnsFirewallDnsFirewall.class));

       return (TypeAdapter<T>) new TypeAdapter<DnsFirewallDnsFirewall>() {
           @Override
           public void write(JsonWriter out, DnsFirewallDnsFirewall value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DnsFirewallDnsFirewall read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of DnsFirewallDnsFirewall given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DnsFirewallDnsFirewall
  * @throws IOException if the JSON string is invalid with respect to DnsFirewallDnsFirewall
  */
  public static DnsFirewallDnsFirewall fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DnsFirewallDnsFirewall.class);
  }

 /**
  * Convert an instance of DnsFirewallDnsFirewall to an JSON string
  *
  * @return JSON string
  */
