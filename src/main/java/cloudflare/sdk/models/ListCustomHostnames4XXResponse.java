 ...
 */
@JsonPropertyOrder({
  ListCustomHostnames4XXResponse.JSON_PROPERTY_ERRORS,
  ListCustomHostnames4XXResponse.JSON_PROPERTY_MESSAGES,
  ListCustomHostnames4XXResponse.JSON_PROPERTY_SUCCESS,
  ListCustomHostnames4XXResponse.JSON_PROPERTY_RESULT,
  ListCustomHostnames4XXResponse.JSON_PROPERTY_RESULT_INFO
})
...
public class ListCustomHostnames4XXResponse {
  ...
  public ListCustomHostnames4XXResponse() { 
  }

  public ListCustomHostnames4XXResponse errors(List<TlsCertificatesAndHostnamesMessagesInner> errors) {
    this.errors = errors;
    return this;
  }

  public ListCustomHostnames4XXResponse addErrorsItem(TlsCertificatesAndHostnamesMessagesInner errorsItem) {
    if (this.errors == null) {
  ...
  **/
  ...
  public ListCustomHostnames4XXResponse messages(List<TlsCertificatesAndHostnamesMessagesInner> messages) {
    this.messages = messages;
    return this;
  }

  public ListCustomHostnames4XXResponse addMessagesItem(TlsCertificatesAndHostnamesMessagesInner messagesItem) {
  ...
  **/
  ...
  public ListCustomHostnames4XXResponse success(Boolean success) {
  ...
  **/
  ...
  public ListCustomHostnames4XXResponse result(ResultEnum result) {
    this.result = result;
    return this;
  }
  ...
  **/
  ...
  public ListCustomHostnames4XXResponse resultInfo(TlsCertificatesAndHostnamesResultInfo resultInfo) {
  ...
  **/
  ...
  /**
   * Return true if this list_custom_hostnames_4XX_response object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    ListCustomHostnames4XXResponse listCustomHostnames4XXResponse = (ListCustomHostnames4XXResponse) o;
    return Objects.equals(this.errors, listCustomHostnames4XXResponse.errors) &&
        Objects.equals(this.messages, listCustomHostnames4XXResponse.messages) &&
        Objects.equals(this.success, listCustomHostnames4XXResponse.success) &&
        Objects.equals(this.result, listCustomHostnames4XXResponse.result) &&
        Objects.equals(this.resultInfo, listCustomHostnames4XXResponse.resultInfo);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListCustomHostnames4XXResponse {\n");
