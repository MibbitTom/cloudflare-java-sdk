...
public class AccessSshProps {
  ...
  public AccessSshProps allowAuthenticateViaWarp(Boolean allowAuthenticateViaWarp) {
  ...
  **/
  ...
  public AccessSshProps allowedIdps(List<String> allowedIdps) {
    this.allowedIdps = allowedIdps;
    return this;
  }

  public AccessSshProps addAllowedIdpsItem(String allowedIdpsItem) {
  ...
  **/
  ...
  public AccessSshProps appLauncherVisible(Boolean appLauncherVisible) {
  ...
  **/
  ...
  public AccessSshProps autoRedirectToIdentity(Boolean autoRedirectToIdentity) {
  ...
  **/
  ...
  public AccessSshProps corsHeaders(AccessCorsHeaders corsHeaders) {
  ...
  **/
  ...
  public AccessSshProps customDenyMessage(String customDenyMessage) {
  ...
  **/
  ...
  public AccessSshProps customDenyUrl(String customDenyUrl) {
  ...
  **/
  ...
  public AccessSshProps customNonIdentityDenyUrl(String customNonIdentityDenyUrl) {
  ...
  **/
  ...
  public AccessSshProps customPages(List<String> customPages) {
    this.customPages = customPages;
    return this;
  }

  public AccessSshProps addCustomPagesItem(String customPagesItem) {
  ...
  **/
  ...
  public AccessSshProps domain(String domain) {
    this.domain = domain;
    return this;
  }
  ...
  **/
  ...
  public AccessSshProps enableBindingCookie(Boolean enableBindingCookie) {
  ...
  **/
  ...
  public AccessSshProps httpOnlyCookieAttribute(Boolean httpOnlyCookieAttribute) {
  ...
  **/
  ...
  public AccessSshProps logoUrl(String logoUrl) {
  ...
  **/
  ...
  public AccessSshProps name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public AccessSshProps optionsPreflightBypass(Boolean optionsPreflightBypass) {
  ...
  **/
  ...
  public AccessSshProps pathCookieAttribute(Boolean pathCookieAttribute) {
  ...
  **/
  ...
  public AccessSshProps sameSiteCookieAttribute(String sameSiteCookieAttribute) {
  ...
  **/
  ...
  public AccessSshProps selfHostedDomains(List<String> selfHostedDomains) {
    this.selfHostedDomains = selfHostedDomains;
    return this;
  }

  public AccessSshProps addSelfHostedDomainsItem(String selfHostedDomainsItem) {
  ...
  **/
  ...
  public AccessSshProps serviceAuth401Redirect(Boolean serviceAuth401Redirect) {
  ...
  **/
  ...
  public AccessSshProps sessionDuration(String sessionDuration) {
  ...
  **/
  ...
  public AccessSshProps skipInterstitial(Boolean skipInterstitial) {
  ...
  **/
  ...
  public AccessSshProps tags(List<String> tags) {
    this.tags = tags;
    return this;
  }

  public AccessSshProps addTagsItem(String tagsItem) {
    if (this.tags == null) {
  ...
  **/
  ...
  public AccessSshProps type(String type) {
    this.type = type;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    AccessSshProps accessSshProps = (AccessSshProps) o;
    return Objects.equals(this.allowAuthenticateViaWarp, accessSshProps.allowAuthenticateViaWarp) &&
        Objects.equals(this.allowedIdps, accessSshProps.allowedIdps) &&
        Objects.equals(this.appLauncherVisible, accessSshProps.appLauncherVisible) &&
        Objects.equals(this.autoRedirectToIdentity, accessSshProps.autoRedirectToIdentity) &&
        Objects.equals(this.corsHeaders, accessSshProps.corsHeaders) &&
        Objects.equals(this.customDenyMessage, accessSshProps.customDenyMessage) &&
        Objects.equals(this.customDenyUrl, accessSshProps.customDenyUrl) &&
        Objects.equals(this.customNonIdentityDenyUrl, accessSshProps.customNonIdentityDenyUrl) &&
        Objects.equals(this.customPages, accessSshProps.customPages) &&
        Objects.equals(this.domain, accessSshProps.domain) &&
        Objects.equals(this.enableBindingCookie, accessSshProps.enableBindingCookie) &&
        Objects.equals(this.httpOnlyCookieAttribute, accessSshProps.httpOnlyCookieAttribute) &&
        Objects.equals(this.logoUrl, accessSshProps.logoUrl) &&
        Objects.equals(this.name, accessSshProps.name) &&
        Objects.equals(this.optionsPreflightBypass, accessSshProps.optionsPreflightBypass) &&
        Objects.equals(this.pathCookieAttribute, accessSshProps.pathCookieAttribute) &&
        Objects.equals(this.sameSiteCookieAttribute, accessSshProps.sameSiteCookieAttribute) &&
        Objects.equals(this.selfHostedDomains, accessSshProps.selfHostedDomains) &&
        Objects.equals(this.serviceAuth401Redirect, accessSshProps.serviceAuth401Redirect) &&
        Objects.equals(this.sessionDuration, accessSshProps.sessionDuration) &&
        Objects.equals(this.skipInterstitial, accessSshProps.skipInterstitial) &&
        Objects.equals(this.tags, accessSshProps.tags) &&
        Objects.equals(this.type, accessSshProps.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class AccessSshProps {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to AccessSshProps
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AccessSshProps.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AccessSshProps is not found in the empty JSON string", AccessSshProps.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AccessSshProps.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AccessSshProps` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AccessSshProps.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AccessSshProps.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AccessSshProps' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AccessSshProps> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AccessSshProps.class));

       return (TypeAdapter<T>) new TypeAdapter<AccessSshProps>() {
           @Override
           public void write(JsonWriter out, AccessSshProps value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AccessSshProps read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of AccessSshProps given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AccessSshProps
  * @throws IOException if the JSON string is invalid with respect to AccessSshProps
  */
  public static AccessSshProps fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AccessSshProps.class);
  }

 /**
  * Convert an instance of AccessSshProps to an JSON string
  *
  * @return JSON string
  */
