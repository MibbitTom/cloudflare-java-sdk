...
| [**workersAiPostRunCfMistralMistral7bInstructV01Vllm**](WorkersAiTextGenerationApi.md#workersAiPostRunCfMistralMistral7bInstructV01Vllm) | **POST** /accounts/{account_id}/ai/run/@cf/mistral/mistral-7b-instruct-v0.1-vllm | Execute @cf/mistral/mistral-7b-instruct-v0.1-vllm model. |
...
| [**workersAiPostRunCfMistralMixtral8x7bInstructV01Awq**](WorkersAiTextGenerationApi.md#workersAiPostRunCfMistralMixtral8x7bInstructV01Awq) | **POST** /accounts/{account_id}/ai/run/@cf/mistral/mixtral-8x7b-instruct-v0.1-awq | Execute @cf/mistral/mixtral-8x7b-instruct-v0.1-awq model. |
...
| [**workersAiPostRunCfSvenTest**](WorkersAiTextGenerationApi.md#workersAiPostRunCfSvenTest) | **POST** /accounts/{account_id}/ai/run/@cf/sven/test | Execute @cf/sven/test model. |
...
<a id="workersAiPostRunCfGoogleGemma7bItLora"></a>
...
<a id="workersAiPostRunCfMetaLlama27bChatInt8"></a>
...
<a id="workersAiPostRunCfMetaLlamaLlama27bChatHfLora"></a>
...
<a id="workersAiPostRunCfMistralMistral7bInstructV01"></a>
...
<a id="workersAiPostRunCfMistralMistral7bInstructV02Lora"></a>
...
<a id="workersAiPostRunCfOpenchatOpenchat350106"></a>
...
<a id="workersAiPostRunCfQwenQwen1514bChatAwq"></a>
...
<a id="workersAiPostRunCfQwenQwen157bChatAwq"></a>
...
<a id="workersAiPostRunCfTheblokeDiscolmGerman7bV1Awq"></a>
...
<a id="workersAiPostRunCfTinyllamaTinyllama11bChatV10"></a>
...
<a id="workersAiPostRunHfMistralMistral7bInstructV02"></a>
...
<a id="workersAiPostRunHfNousresearchHermes2ProMistral7b"></a>
...
<a id="workersAiPostRunHfTheblokeDeepseekCoder67bBaseAwq"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    OneOf body = new HashMap(); // OneOf | 
    try {
      WorkersAiPostRunCfDeepseekAiDeepseekMath7bInstruct200Response result = apiInstance.workersAiPostRunHfTheblokeDeepseekCoder67bBaseAwq(accountId, body);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling WorkersAiTextGenerationApi#workersAiPostRunHfTheblokeDeepseekCoder67bBaseAwq");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="workersAiPostRunHfTheblokeDeepseekCoder67bInstructAwq"></a>
# **workersAiPostRunHfTheblokeDeepseekCoder67bInstructAwq**
> WorkersAiPostRunCfDeepseekAiDeepseekMath7bInstruct200Response workersAiPostRunHfTheblokeDeepseekCoder67bInstructAwq(accountId, body)
...
public class Example {
  public static void main(String[] args) {
    ...
    OneOf body = new HashMap(); // OneOf | 
    try {
      WorkersAiPostRunCfDeepseekAiDeepseekMath7bInstruct200Response result = apiInstance.workersAiPostRunHfTheblokeDeepseekCoder67bInstructAwq(accountId, body);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling WorkersAiTextGenerationApi#workersAiPostRunHfTheblokeDeepseekCoder67bInstructAwq");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="workersAiPostRunHfTheblokeLlama213bChatAwq"></a>
# **workersAiPostRunHfTheblokeLlama213bChatAwq**
> WorkersAiPostRunCfDeepseekAiDeepseekMath7bInstruct200Response workersAiPostRunHfTheblokeLlama213bChatAwq(accountId, body)
...
public class Example {
  public static void main(String[] args) {
    ...
    OneOf body = new HashMap(); // OneOf | 
    try {
      WorkersAiPostRunCfDeepseekAiDeepseekMath7bInstruct200Response result = apiInstance.workersAiPostRunHfTheblokeLlama213bChatAwq(accountId, body);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling WorkersAiTextGenerationApi#workersAiPostRunHfTheblokeLlama213bChatAwq");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="workersAiPostRunHfTheblokeLlamaguard7bAwq"></a>
# **workersAiPostRunHfTheblokeLlamaguard7bAwq**
> WorkersAiPostRunCfDeepseekAiDeepseekMath7bInstruct200Response workersAiPostRunHfTheblokeLlamaguard7bAwq(accountId, body)
...
public class Example {
  public static void main(String[] args) {
    ...
    OneOf body = new HashMap(); // OneOf | 
    try {
      WorkersAiPostRunCfDeepseekAiDeepseekMath7bInstruct200Response result = apiInstance.workersAiPostRunHfTheblokeLlamaguard7bAwq(accountId, body);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling WorkersAiTextGenerationApi#workersAiPostRunHfTheblokeLlamaguard7bAwq");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="workersAiPostRunHfTheblokeMistral7bInstructV01Awq"></a>
# **workersAiPostRunHfTheblokeMistral7bInstructV01Awq**
> WorkersAiPostRunCfDeepseekAiDeepseekMath7bInstruct200Response workersAiPostRunHfTheblokeMistral7bInstructV01Awq(accountId, body)
...
public class Example {
  public static void main(String[] args) {
    ...
    OneOf body = new HashMap(); // OneOf | 
    try {
      WorkersAiPostRunCfDeepseekAiDeepseekMath7bInstruct200Response result = apiInstance.workersAiPostRunHfTheblokeMistral7bInstructV01Awq(accountId, body);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling WorkersAiTextGenerationApi#workersAiPostRunHfTheblokeMistral7bInstructV01Awq");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="workersAiPostRunHfTheblokeNeuralChat7bV31Awq"></a>
# **workersAiPostRunHfTheblokeNeuralChat7bV31Awq**
> WorkersAiPostRunCfDeepseekAiDeepseekMath7bInstruct200Response workersAiPostRunHfTheblokeNeuralChat7bV31Awq(accountId, body)
...
public class Example {
  public static void main(String[] args) {
    ...
    OneOf body = new HashMap(); // OneOf | 
    try {
      WorkersAiPostRunCfDeepseekAiDeepseekMath7bInstruct200Response result = apiInstance.workersAiPostRunHfTheblokeNeuralChat7bV31Awq(accountId, body);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling WorkersAiTextGenerationApi#workersAiPostRunHfTheblokeNeuralChat7bV31Awq");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="workersAiPostRunHfTheblokeOpenchat35Awq"></a>
# **workersAiPostRunHfTheblokeOpenchat35Awq**
> WorkersAiPostRunCfDeepseekAiDeepseekMath7bInstruct200Response workersAiPostRunHfTheblokeOpenchat35Awq(accountId, body)
...
public class Example {
  public static void main(String[] args) {
    ...
    OneOf body = new HashMap(); // OneOf | 
    try {
      WorkersAiPostRunCfDeepseekAiDeepseekMath7bInstruct200Response result = apiInstance.workersAiPostRunHfTheblokeOpenchat35Awq(accountId, body);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling WorkersAiTextGenerationApi#workersAiPostRunHfTheblokeOpenchat35Awq");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="workersAiPostRunHfTheblokeOpenhermes25Mistral7bAwq"></a>
# **workersAiPostRunHfTheblokeOpenhermes25Mistral7bAwq**
> WorkersAiPostRunCfDeepseekAiDeepseekMath7bInstruct200Response workersAiPostRunHfTheblokeOpenhermes25Mistral7bAwq(accountId, body)
...
public class Example {
  public static void main(String[] args) {
    ...
    OneOf body = new HashMap(); // OneOf | 
    try {
      WorkersAiPostRunCfDeepseekAiDeepseekMath7bInstruct200Response result = apiInstance.workersAiPostRunHfTheblokeOpenhermes25Mistral7bAwq(accountId, body);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling WorkersAiTextGenerationApi#workersAiPostRunHfTheblokeOpenhermes25Mistral7bAwq");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="workersAiPostRunHfTheblokeZephyr7bBetaAwq"></a>
# **workersAiPostRunHfTheblokeZephyr7bBetaAwq**
> WorkersAiPostRunCfDeepseekAiDeepseekMath7bInstruct200Response workersAiPostRunHfTheblokeZephyr7bBetaAwq(accountId, body)
...
public class Example {
  public static void main(String[] args) {
    ...
    OneOf body = new HashMap(); // OneOf | 
    try {
      WorkersAiPostRunCfDeepseekAiDeepseekMath7bInstruct200Response result = apiInstance.workersAiPostRunHfTheblokeZephyr7bBetaAwq(accountId, body);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling WorkersAiTextGenerationApi#workersAiPostRunHfTheblokeZephyr7bBetaAwq");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
