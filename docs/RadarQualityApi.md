...
|------------- | ------------- | -------------|
| [**radarGetQualityIndexSummary**](RadarQualityApi.md#radarGetQualityIndexSummary) | **GET** /radar/quality/iqi/summary | Get IQI Summary |
| [**radarGetQualityIndexTimeseriesGroup**](RadarQualityApi.md#radarGetQualityIndexTimeseriesGroup) | **GET** /radar/quality/iqi/timeseries_groups | Get IQI Time Series |
...
| [**radarGetQualitySpeedTopAses**](RadarQualityApi.md#radarGetQualitySpeedTopAses) | **GET** /radar/quality/speed/top/ases | Get Top Speed Test Autonomous Systems |
| [**radarGetQualitySpeedTopLocations**](RadarQualityApi.md#radarGetQualitySpeedTopLocations) | **GET** /radar/quality/speed/top/locations | Get Top Speed Test Locations |


<a id="radarGetQualityIndexSummary"></a>
...
import cloudflare.sdk.RadarQualityApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    RadarQualityApi apiInstance = new RadarQualityApi(defaultClient);
    String metric = "BANDWIDTH"; // String | 
    ...
    try {
      RadarGetQualityIndexSummary200Response result = apiInstance.radarGetQualityIndexSummary(metric, name, dateRange, dateStart, dateEnd, asn, location, continent, format);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling RadarQualityApi#radarGetQualityIndexSummary");
...
|------------- | ------------- | ------------- | -------------|
| **metric** | **String**|  | [enum: BANDWIDTH, DNS, LATENCY] |
...
<a id="radarGetQualityIndexTimeseriesGroup"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    List<String> location = Arrays.asList(); // List<String> | 
    List<String> continent = Arrays.asList(); // List<String> | 
    Boolean interpolation = true; // Boolean | 
    String format = "JSON"; // String | 
    try {
      RadarGetQualityIndexTimeseriesGroup200Response result = apiInstance.radarGetQualityIndexTimeseriesGroup(metric, aggInterval, name, dateRange, dateStart, dateEnd, asn, location, continent, interpolation, format);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling RadarQualityApi#radarGetQualityIndexTimeseriesGroup");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="radarGetQualitySpeedHistogram"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    String metricGroup = "BANDWIDTH"; // String | 
    String format = "JSON"; // String | 
    try {
      RadarGetQualitySpeedHistogram200Response result = apiInstance.radarGetQualitySpeedHistogram(name, dateEnd, asn, location, continent, bucketSize, metricGroup, format);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling RadarQualityApi#radarGetQualitySpeedHistogram");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
| **metricGroup** | **String**|  | [optional] [default to bandwidth] [enum: BANDWIDTH, LATENCY, JITTER] |
| **format** | **String**|  | [optional] [enum: JSON, CSV] |
...
<a id="radarGetQualitySpeedSummary"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    String format = "JSON"; // String | 
    try {
      RadarGetQualitySpeedSummary200Response result = apiInstance.radarGetQualitySpeedSummary(name, dateEnd, asn, location, continent, format);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling RadarQualityApi#radarGetQualitySpeedSummary");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="radarGetQualitySpeedTopAses"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    List<String> location = Arrays.asList(); // List<String> | 
    List<String> continent = Arrays.asList(); // List<String> | 
    String orderBy = "BANDWIDTH_DOWNLOAD"; // String | 
    Boolean reverse = true; // Boolean | 
    String format = "JSON"; // String | 
    try {
      RadarGetQualitySpeedTopAses200Response result = apiInstance.radarGetQualitySpeedTopAses(limit, name, dateEnd, asn, location, continent, orderBy, reverse, format);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling RadarQualityApi#radarGetQualitySpeedTopAses");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
| **location** | [**List&lt;String&gt;**](String.md)|  | [optional] |
| **continent** | [**List&lt;String&gt;**](String.md)|  | [optional] |
| **orderBy** | **String**|  | [optional] [default to BANDWIDTH_DOWNLOAD] [enum: BANDWIDTH_DOWNLOAD, BANDWIDTH_UPLOAD, LATENCY_IDLE, LATENCY_LOADED, JITTER_IDLE, JITTER_LOADED] |
...
<a id="radarGetQualitySpeedTopLocations"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    String format = "JSON"; // String | 
    try {
      RadarGetQualitySpeedTopLocations200Response result = apiInstance.radarGetQualitySpeedTopLocations(limit, name, dateEnd, asn, location, continent, orderBy, reverse, format);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling RadarQualityApi#radarGetQualitySpeedTopLocations");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
