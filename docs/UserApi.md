...
public class Example {
  public static void main(String[] args) {
    ...
    UserEditUserRequest userEditUserRequest = new UserEditUserRequest(); // UserEditUserRequest | 
    try {
      IamSingleUserResponse result = apiInstance.userEditUser(userEditUserRequest);
...
public class Example {
  public static void main(String[] args) {
    ...
    UserApi apiInstance = new UserApi(defaultClient);
    try {
      IamSingleUserResponse result = apiInstance.userUserDetails();
      System.out.println(result);
    } catch (ApiException e) {
